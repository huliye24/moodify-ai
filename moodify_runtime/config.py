...
class RuntimeConfig:
    ...
    operator_detail_dir: Path = Path("data/moodify_runtime/operator_job_details")
    operator_deliveries_path: Path = Path("data/moodify_runtime/operator_deliveries.jsonl")
    operator_report_dir: Path = Path("reports/operator_runs")
    studio_data_dir: Path = Path("data/moodify_runtime/studio")
    scheduler_data_dir: Path = Path("data/moodify_runtime/scheduler")
    calibration_data_dir: Path = Path("data/moodify_runtime/calibration")
    ...
    def resolved(self) -> "RuntimeConfig":
        ...
        clone.operator_detail_dir = rp(self.operator_detail_dir)
        clone.operator_deliveries_path = rp(self.operator_deliveries_path)
        clone.operator_report_dir = rp(self.operator_report_dir)
        clone.studio_data_dir = rp(self.studio_data_dir)
        clone.scheduler_data_dir = rp(self.scheduler_data_dir)
        clone.calibration_data_dir = rp(self.calibration_data_dir)
