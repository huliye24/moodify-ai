...
def test_release_cli_entry_contract():
    """CLI v2 是规范入口；JSON 契约文件存在。"""
    pyproject = (CORE_PACKAGE_ROOT / "pyproject.toml").read_text(encoding="utf-8")
    assert 'moodify = "moodify.release_cli:main"' in pyproject
