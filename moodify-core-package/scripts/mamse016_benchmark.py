"""MAMSE-016 resource benchmark: wall/CPU, RSS, swap, dense intermediate.

Usage: python scripts/mamse016_benchmark.py <wav> <out.json>
...
def measure(samples: np.ndarray, sr: int, label: str) -> dict:
    ...
    build_pitch_sketch(obs, DEFAULT_CONFIG)
