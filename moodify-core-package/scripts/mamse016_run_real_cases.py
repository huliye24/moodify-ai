"""Run MAMSE-016 on real cases and emit evidence.

Usage: python scripts/mamse016_run_real_cases.py <source.wav ...> --out <dir>
"""
...
def main() -> None:
    ...
    for source in args.sources:
        ...
        obs = compute_pitch_observation(samples, sr, DEFAULT_CONFIG)
        sketch = build_pitch_sketch(obs, DEFAULT_CONFIG)
        case_dir = out_root / f"{path.stem}_mamse016"
    ...
    (out_root / "mamse016_summary.json").write_text(
