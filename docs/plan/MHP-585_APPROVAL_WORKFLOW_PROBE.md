# MHP-585: Approval Workflow Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-PROBE-030 / Probe Plan-6B: Technical Probe / P11 (Systemization)
**Depends on**: MHP-584
...
Complete `Approval Workflow Probe` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`docs/spec/approval_workflow_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP585
aep_id: AEP-MOODIFY-MHP585
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-585-20260604
