# MHP-213: Listening Probe Decision

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-PROBE-009 / Probe Plan-6C: Feasibility Gate / P17 (Systemization)
**Depends on**: MHP-212
...
Complete `Listening Probe Decision` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_213_listening_probe_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP213
aep_id: AEP-MOODIFY-MHP213
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP213-20260604
