# MHP-269: Worker Lease Model

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-BUILD-013 / Build Plan-6A: Core Implementation / B1 (Execution)
**Depends on**: MHP-268
...
Complete `Worker Lease Model` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/worker_lease_model.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP269
aep_id: AEP-MOODIFY-MHP269
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP269-20260604
