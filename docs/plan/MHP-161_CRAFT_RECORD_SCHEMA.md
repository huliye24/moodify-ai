# MHP-161: Craft Record Schema

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PRESET-CRAFT-002 / NEM-MOODIFY-PRESET-BUILD-007 / Build Plan-6A: Core Implementation / B1 (Execution)
**Depends on**: MHP-160
...
Complete `Craft Record Schema` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/craft_record_schema.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP161
aep_id: AEP-MOODIFY-MHP161
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP161-20260604
