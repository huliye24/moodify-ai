# MHP-432: Raw Scan PDF Generator

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-BUILD-022 / Build Plan-6A: PDF Core / B2 (Execution)
**Depends on**: MHP-431
...
Complete `Raw Scan PDF Generator` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/acoustic_ct/raw_scan_pdf_generator.pdf`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP432
aep_id: AEP-MOODIFY-MHP432
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP432-20260604
