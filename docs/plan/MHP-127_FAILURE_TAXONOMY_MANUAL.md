# MHP-127: Failure Taxonomy Manual

**Status**: completed
**Direction**: ECHAIN-MOODIFY-RUNTIME-001 / NEM-MOODIFY-RUNTIME-SYSTEM-005 / System Plan-6A: Standardization / S3 (Validation)
**Depends on**: MHP-126
...
Complete `Failure Taxonomy Manual` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `docs/RUNTIME_FAILURE_MANUAL.md`.

## Expected Output

`docs/RUNTIME_FAILURE_MANUAL.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP127
aep_id: AEP-MOODIFY-MHP127
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP127-20260604
