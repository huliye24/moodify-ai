...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-INTELLIGENCE-009 / NEM-MOODIFY-TIDAL-INTEL-BUILD-028 / Build Plan-6A: Core Implementation / B2 (Execution)
**Depends on**: MHP-539
...
Complete `Task Priority Model` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_intelligence_009/mhp_540_task_priority_model.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP540
aep_id: AEP-MOODIFY-MHP540
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-540-20260604
