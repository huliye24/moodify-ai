# MHP-276: Cloud API Endpoints

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-BUILD-013 / Build Plan-6B: Runtime/Product Integration / B8 (Execution)
**Depends on**: MHP-275
...
Complete `Cloud API Endpoints` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/cloud_api_endpoints.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP276
aep_id: AEP-MOODIFY-MHP276
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP276-20260604
