...
Complete `Cloud Ownership Map` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/cloud_ownership_map.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP300
aep_id: AEP-MOODIFY-MHP300
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP300-20260604
