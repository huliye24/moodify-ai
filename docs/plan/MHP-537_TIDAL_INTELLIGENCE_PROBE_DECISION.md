# MHP-537: Tidal Intelligence Probe Decision

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-INTELLIGENCE-009 / NEM-MOODIFY-TIDAL-INTEL-PROBE-027 / Probe Plan-6C: Feasibility Gate / P17 (Systemization)
**Depends on**: MHP-536
...
Complete `Tidal Intelligence Probe Decision` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`docs/spec/tidal_intelligence_probe_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP537
aep_id: AEP-MOODIFY-MHP537
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-537-20260604
