# MHP-441: CT Report Config Profiles

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-BUILD-022 / Build Plan-6B: Runtime and Product Integration / B11 (Systemization)
**Depends on**: MHP-440
...
Complete `CT Report Config Profiles` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`docs/spec/ct_report_config_profiles.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP441
aep_id: AEP-MOODIFY-MHP441
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP441-20260604
