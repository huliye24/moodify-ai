...
Complete `Next Operator Chain Candidates` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_356_next_operator_chain_candidates.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP356
aep_id: AEP-MOODIFY-MHP356
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP356-20260604
