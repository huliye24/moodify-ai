# MHP-434: Before After Comparison Plate

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-BUILD-022 / Build Plan-6A: PDF Core / B4 (Validation)
**Depends on**: MHP-433
...
Complete `Before After Comparison Plate` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/acoustic_ct/before_after_comparison_plate.pdf`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP434
aep_id: AEP-MOODIFY-MHP434
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP434-20260604
