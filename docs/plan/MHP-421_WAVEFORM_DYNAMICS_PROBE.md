# MHP-421: Waveform Dynamics Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6B: Plot Feasibility Probe / P9 (Validation)
**Depends on**: MHP-420
...
Complete `Waveform Dynamics Probe` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_421_waveform_dynamics_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP421
aep_id: AEP-MOODIFY-MHP421
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP421-20260604
