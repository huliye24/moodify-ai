...
Complete `Gate Accuracy Re-Evaluation` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_229_gate_accuracy_re_evaluation.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP229
aep_id: AEP-MOODIFY-MHP229
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP229-20260604
