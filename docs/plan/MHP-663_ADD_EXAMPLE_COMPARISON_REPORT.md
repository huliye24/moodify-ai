# MHP-663: Add Example Comparison Report

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-ACOUSTIC-CT-BUILD-034 / Build Plan-6C: Product Integration / B17 (Systemization)
**Depends on**: MHP-662
...
`reports/echain-moodify-pdf-report-011/mhp_663_add_example_comparison_report.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP663
aep_id: AEP-MOODIFY-MHP663
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-663-20260604
