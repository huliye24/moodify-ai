...
Complete `E-Chain Gate 3 Decision` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `reports/runtime_system/echain_gate3_decision.md`.

## Expected Output

`reports/runtime_system/echain_gate3_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP141
aep_id: AEP-MOODIFY-MHP141
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP141-20260604
