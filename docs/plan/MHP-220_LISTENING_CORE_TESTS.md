...
Complete `Listening Core Tests` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_220_listening_core_tests.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP220
aep_id: AEP-MOODIFY-MHP220
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP220-20260604
