# MHP-442: CT Integration Smoke

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-BUILD-022 / Build Plan-6B: Runtime and Product Integration / B12 (Next Entry)
**Depends on**: MHP-441
...
Complete `CT Integration Smoke` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_442_ct_integration_smoke.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP442
aep_id: AEP-MOODIFY-MHP442
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP442-20260604
