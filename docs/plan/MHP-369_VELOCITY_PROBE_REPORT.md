# MHP-369: Velocity Probe Report

**Status**: completed
**Direction**: ECHAIN-MOODIFY-VELOCITY-006 / NEM-MOODIFY-VELOCITY-PROBE-018 / Probe Plan-6B: Velocity Instrumentation / P11 (Systemization)
**Depends on**: MHP-368
...
Complete `Velocity Probe Report` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_369_velocity_probe_report.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP369
aep_id: AEP-MOODIFY-MHP369
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP369-20260604
