# MHP-202: Listening Probe Backlog

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-PROBE-009 / Probe Plan-6A: Problem Boundary / P6 (Next Entry)
**Depends on**: MHP-201
...
Complete `Listening Probe Backlog` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_202_listening_probe_backlog.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP202
aep_id: AEP-MOODIFY-MHP202
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP202-20260604
