...
Complete `Reviewer Bias Risk Map` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_199_reviewer_bias_risk_map.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP199
aep_id: AEP-MOODIFY-MHP199
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP199-20260604
