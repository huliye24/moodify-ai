# MHP-508: Tidal Core System Decision

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-SYSTEM-026 / System Plan-6A: Standardization / S6 (Next Entry)
**Depends on**: MHP-507
...
Complete `Tidal Core System Decision` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_core_008/mhp_508_tidal_core_system_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP508
aep_id: AEP-MOODIFY-MHP508
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-508-20260604
