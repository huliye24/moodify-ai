...
Complete `Minimal Unattended 2h Probe` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `reports/runtime_probe/minimal_unattended_2h.md`.

## Expected Output

`reports/runtime_probe/minimal_unattended_2h.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP102
aep_id: AEP-MOODIFY-MHP102
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP102-20260604
