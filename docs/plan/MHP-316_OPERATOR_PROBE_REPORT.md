# MHP-316: Operator Probe Report

**Status**: completed
**Direction**: ECHAIN-MOODIFY-OPERATOR-OS-005 / NEM-MOODIFY-OPERATOR-PROBE-015 / Probe Plan-6B: Technical Probe / P12 (Next Entry)
**Depends on**: MHP-315
...
Complete `Operator Probe Report` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_316_operator_probe_report.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP316
aep_id: AEP-MOODIFY-MHP316
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP316-20260604
