# MHP-491: Tidal CLI Commands

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-BUILD-025 / Build Plan-6B: Runtime Integration / B7 (Execution)
**Depends on**: MHP-490
...
Complete `Tidal CLI Commands` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_core_008/mhp_491_tidal_cli_commands.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP491
aep_id: AEP-MOODIFY-MHP491
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-491-20260604
