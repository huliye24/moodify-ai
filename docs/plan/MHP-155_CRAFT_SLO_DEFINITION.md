# MHP-155: Craft SLO Definition

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PRESET-CRAFT-002 / NEM-MOODIFY-PRESET-PROBE-006 / Probe Plan-6C: Feasibility Gate / P13 (Execution)
**Depends on**: MHP-154
...
Complete `Craft SLO Definition` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/craft_slo_definition.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP155
aep_id: AEP-MOODIFY-MHP155
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP155-20260604
