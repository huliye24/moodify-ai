# MHP-670: CLI/API Integration Smoke

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-OPS-QA-SYSTEM-035 / System Plan-6A: CLI and API / S6 (Next Entry)
**Depends on**: MHP-669
...
`reports/echain-moodify-pdf-report-011/mhp_670_cli_api_integration_smoke.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP670
aep_id: AEP-MOODIFY-MHP670
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-670-20260604
