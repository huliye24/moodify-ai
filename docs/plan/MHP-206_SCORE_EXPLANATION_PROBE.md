# MHP-206: Score Explanation Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-PROBE-009 / Probe Plan-6B: Technical Probe / P10 (Validation)
**Depends on**: MHP-205
...
Complete `Score Explanation Probe` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_206_score_explanation_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP206
aep_id: AEP-MOODIFY-MHP206
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP206-20260604
