...
Complete `Listening Problem Brief` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/listening_problem_brief.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP197
aep_id: AEP-MOODIFY-MHP197
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP197-20260604
