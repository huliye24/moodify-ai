# MHP-723: Add Acoustic CT Feedback Hook

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-INTELLIGENCE-SYSTEM-038 / System Plan-6A: Selector Core / S5 (Systemization)
**Depends on**: MHP-722
...
`reports/echain-moodify-craft-22-012/mhp_723_add_acoustic_ct_feedback_hook.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP723
aep_id: AEP-MOODIFY-MHP723
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-723-20260604
