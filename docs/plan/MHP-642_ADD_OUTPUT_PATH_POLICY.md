# MHP-642: Add Output Path Policy

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-FOUNDATION-PROBE-033 / Probe Plan-6C: Foundation Gate / P14 (Execution)
**Depends on**: MHP-641
...
`reports/echain-moodify-pdf-report-011/mhp_642_add_output_path_policy.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP642
aep_id: AEP-MOODIFY-MHP642
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-642-20260604
