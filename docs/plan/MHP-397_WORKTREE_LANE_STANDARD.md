# MHP-397: Worktree Lane Standard

**Status**: completed
**Direction**: ECHAIN-MOODIFY-VELOCITY-006 / NEM-MOODIFY-VELOCITY-SYSTEM-020 / System Plan-6A: Velocity Standards / S3 (Validation)
**Depends on**: MHP-396
...
Complete `Worktree Lane Standard` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_397_worktree_lane_standard.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP397
aep_id: AEP-MOODIFY-MHP397
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP397-20260604
