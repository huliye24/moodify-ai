# MHP-665: Add CLI pdf-report render-single

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-OPS-QA-SYSTEM-035 / System Plan-6A: CLI and API / S1 (Execution)
**Depends on**: MHP-664
...
`reports/echain-moodify-pdf-report-011/mhp_665_add_cli_pdf-report_render-single.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP665
aep_id: AEP-MOODIFY-MHP665
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-665-20260604
