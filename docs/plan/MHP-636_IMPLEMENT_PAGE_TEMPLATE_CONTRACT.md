# MHP-636: Implement Page Template Contract

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-FOUNDATION-PROBE-033 / Probe Plan-6B: Template Foundation / P8 (Execution)
**Depends on**: MHP-635
...
`reports/echain-moodify-pdf-report-011/mhp_636_implement_page_template_contract.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP636
aep_id: AEP-MOODIFY-MHP636
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-636-20260604
