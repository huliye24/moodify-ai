...
Complete `Reviewer Agreement Metrics` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_218_reviewer_agreement_metrics.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP218
aep_id: AEP-MOODIFY-MHP218
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP218-20260604
