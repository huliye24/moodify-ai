# MHP-237: Listening Audit Report

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-SYSTEM-011 / System Plan-6A: Standardization / S5 (Systemization)
**Depends on**: MHP-236
...
Complete `Listening Audit Report` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_237_listening_audit_report.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP237
aep_id: AEP-MOODIFY-MHP237
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP237-20260604
