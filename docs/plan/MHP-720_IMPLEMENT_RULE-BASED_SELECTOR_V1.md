# MHP-720: Implement Rule-Based Selector v1

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-INTELLIGENCE-SYSTEM-038 / System Plan-6A: Selector Core / S2 (Execution)
**Depends on**: MHP-719
...
`reports/echain-moodify-craft-22-012/mhp_720_implement_rule-based_selector_v1.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP720
aep_id: AEP-MOODIFY-MHP720
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-720-20260604
