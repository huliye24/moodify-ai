...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-PROBE-024 / Probe Plan-6C: Feasibility Gate / P13 (Execution)
**Depends on**: MHP-478
...
Complete `Tidal Core SLO Definition` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_core_008/mhp_479_tidal_core_slo_definition.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP479
aep_id: AEP-MOODIFY-MHP479
nem_id: NEM-MOODIFY-TIDAL-CORE-PROBE-024
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-479-20260604
