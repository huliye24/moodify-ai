...
Complete `Cloud Resource Cost Summary` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_284_cloud_resource_cost_summary.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP284
aep_id: AEP-MOODIFY-MHP284
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP284-20260604
