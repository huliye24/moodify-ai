# MHP-525: Improvement Loop Risk Brief

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-INTELLIGENCE-009 / NEM-MOODIFY-TIDAL-INTEL-PROBE-027 / Probe Plan-6A: Boundary / P5 (Systemization)
**Depends on**: MHP-524
...
Complete `Improvement Loop Risk Brief` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`docs/spec/improvement_loop_risk_brief.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP525
aep_id: AEP-MOODIFY-MHP525
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-525-20260604
