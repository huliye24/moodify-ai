...
Complete `Worktree Isolation Feasibility Probe` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_372_worktree_isolation_feasibility_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP372
aep_id: AEP-MOODIFY-MHP372
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP372-20260604
