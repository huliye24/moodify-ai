# MHP-613: Alert Severity Standard

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-SYSTEM-032 / System Plan-6A: Standardization / S3 (Validation)
**Depends on**: MHP-612
...
Complete `Alert Severity Standard` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_operations_010/mhp_613_alert_severity_standard.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP613
aep_id: AEP-MOODIFY-MHP613
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-613-20260604
