...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-BUILD-031 / Build Plan-6B: Runtime Integration / B7 (Execution)
**Depends on**: MHP-598
...
Complete `Tidal Alert Writer` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_operations_010/mhp_599_tidal_alert_writer.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP599
aep_id: AEP-MOODIFY-MHP599
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-599-20260604
