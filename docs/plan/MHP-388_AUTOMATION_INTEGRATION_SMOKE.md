...
Complete `Automation Integration Smoke` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_388_automation_integration_smoke.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP388
aep_id: AEP-MOODIFY-MHP388
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP388-20260604
