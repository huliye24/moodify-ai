# MHP-418: Acoustic CT Probe Backlog

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6A: Visual Diagnosis Boundary / P6 (Next Entry)
**Depends on**: MHP-417
...
Complete `Acoustic CT Probe Backlog` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_418_acoustic_ct_probe_backlog.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP418
aep_id: AEP-MOODIFY-MHP418
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP418-20260604
