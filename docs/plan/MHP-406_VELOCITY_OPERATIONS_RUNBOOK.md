...
Complete `Velocity Operations Runbook` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_406_velocity_operations_runbook.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP406
aep_id: AEP-MOODIFY-MHP406
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP406-20260604
