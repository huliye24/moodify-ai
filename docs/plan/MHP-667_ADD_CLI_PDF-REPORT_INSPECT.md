# MHP-667: Add CLI pdf-report inspect

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-OPS-QA-SYSTEM-035 / System Plan-6A: CLI and API / S3 (Validation)
**Depends on**: MHP-666
...
`reports/echain-moodify-pdf-report-011/mhp_667_add_cli_pdf-report_inspect.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP667
aep_id: AEP-MOODIFY-MHP667
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-667-20260604
