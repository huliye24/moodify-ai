# MHP-591: Tidal Operations Probe Decision

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-PROBE-030 / Probe Plan-6C: Feasibility Gate / P17 (Systemization)
**Depends on**: MHP-590
...
Complete `Tidal Operations Probe Decision` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`docs/spec/tidal_operations_probe_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP591
aep_id: AEP-MOODIFY-MHP591
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-591-20260604
