# MHP-713: Add Deterministic Seed/Config

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-CHAIN-BUILD-037 / Build Plan-6C: CLI and Product / B13 (Execution)
**Depends on**: MHP-712
...
`reports/echain-moodify-craft-22-012/mhp_713_add_deterministic_seed_config.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP713
aep_id: AEP-MOODIFY-MHP713
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-713-20260604
