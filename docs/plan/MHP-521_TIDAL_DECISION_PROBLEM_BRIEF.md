# MHP-521: Tidal Decision Problem Brief

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-INTELLIGENCE-009 / NEM-MOODIFY-TIDAL-INTEL-PROBE-027 / Probe Plan-6A: Boundary / P1 (Execution)
**Depends on**: MHP-466
...
Complete `Tidal Decision Problem Brief` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_intelligence_009/mhp_521_tidal_decision_problem_brief.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP521
aep_id: AEP-MOODIFY-MHP521
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-521-20260604
