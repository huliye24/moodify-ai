# MHP-422: Stereo Image Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6B: Plot Feasibility Probe / P10 (Validation)
**Depends on**: MHP-421
...
Complete `Stereo Image Probe` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_422_stereo_image_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP422
aep_id: AEP-MOODIFY-MHP422
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP422-20260604
