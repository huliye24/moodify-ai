# MHP-414: Visual Diagnostic Vocabulary

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6A: Visual Diagnosis Boundary / P2 (Execution)
**Depends on**: MHP-413
...
Complete `Visual Diagnostic Vocabulary` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_414_visual_diagnostic_vocabulary.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP414
aep_id: AEP-MOODIFY-MHP414
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP414-20260604
