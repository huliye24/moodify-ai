# MHP-567: Tidal Intelligence Product Smoke

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-INTELLIGENCE-009 / NEM-MOODIFY-TIDAL-INTEL-SYSTEM-029 / System Plan-6B: Team Workflow / S11 (Systemization)
**Depends on**: MHP-566
...
Complete `Tidal Intelligence Product Smoke` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`docs/spec/tidal_intelligence_product_smoke.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP567
aep_id: AEP-MOODIFY-MHP567
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-567-20260604
