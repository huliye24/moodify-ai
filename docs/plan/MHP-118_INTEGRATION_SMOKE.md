...
Complete `Runtime Integration Smoke` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `reports/runtime_build/integration_smoke.md`.

## Expected Output

`reports/runtime_build/integration_smoke.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP118
aep_id: AEP-MOODIFY-MHP118
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP118-20260604
