...
Complete `Supervisor CLI Commands` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `moodify_runtime/cli.py`.
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP113
aep_id: AEP-MOODIFY-MHP113
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP113-20260604
