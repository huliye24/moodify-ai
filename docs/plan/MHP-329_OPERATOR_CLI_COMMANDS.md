# MHP-329: Operator CLI Commands

**Status**: completed
**Direction**: ECHAIN-MOODIFY-OPERATOR-OS-005 / NEM-MOODIFY-OPERATOR-BUILD-016 / Build Plan-6B: Runtime/Product Integration / B7 (Execution)
**Depends on**: MHP-328
...
Complete `Operator CLI Commands` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/operator_cli_commands.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP329
aep_id: AEP-MOODIFY-MHP329
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP329-20260604
