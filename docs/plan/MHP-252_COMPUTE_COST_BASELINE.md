# MHP-252: Compute Cost Baseline

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-PROBE-012 / Probe Plan-6A: Problem Boundary / P2 (Execution)
**Depends on**: MHP-251
...
Complete `Compute Cost Baseline` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/compute_cost_baseline.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP252
aep_id: AEP-MOODIFY-MHP252
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP252-20260604
