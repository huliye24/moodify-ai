# MHP-653: Add Diagnostic Callouts

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-ACOUSTIC-CT-BUILD-034 / Build Plan-6B: Comparison Layer / B7 (Execution)
**Depends on**: MHP-652
...
`reports/echain-moodify-pdf-report-011/mhp_653_add_diagnostic_callouts.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP653
aep_id: AEP-MOODIFY-MHP653
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-653-20260604
