...
Complete `Night Run Scheduler` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`docs/spec/night_run_scheduler.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP389
aep_id: AEP-MOODIFY-MHP389
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP389-20260604
