...
Complete `Runtime Status Integration` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_332_runtime_status_integration.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP332
aep_id: AEP-MOODIFY-MHP332
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP332-20260604
