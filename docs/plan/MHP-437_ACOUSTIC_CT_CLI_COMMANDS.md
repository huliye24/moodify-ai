# MHP-437: Acoustic CT CLI Commands

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-BUILD-022 / Build Plan-6B: Runtime and Product Integration / B7 (Execution)
**Depends on**: MHP-436
...
Complete `Acoustic CT CLI Commands` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_437_acoustic_ct_cli_commands.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP437
aep_id: AEP-MOODIFY-MHP437
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP437-20260604
