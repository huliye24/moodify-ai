...
Complete `Cloud Operations Manual` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_297_cloud_operations_manual.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP297
aep_id: AEP-MOODIFY-MHP297
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP297-20260604
