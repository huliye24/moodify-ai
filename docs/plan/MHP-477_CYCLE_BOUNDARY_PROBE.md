...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-PROBE-024 / Probe Plan-6B: Technical Probe / P11 (Systemization)
**Depends on**: MHP-476
...
Complete `Cycle Boundary Probe` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`docs/spec/cycle_boundary_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP477
aep_id: AEP-MOODIFY-MHP477
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-477-20260604
