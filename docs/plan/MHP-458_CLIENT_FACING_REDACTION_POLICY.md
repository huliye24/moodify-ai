# MHP-458: Client Facing Redaction Policy

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-SYSTEM-023 / System Plan-6B: Operator and Delivery Workflow / S10 (Validation)
**Depends on**: MHP-457
...
Complete `Client Facing Redaction Policy` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_458_client_facing_redaction_policy.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP458
aep_id: AEP-MOODIFY-MHP458
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP458-20260604
