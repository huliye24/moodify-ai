...
Complete `Craft Core Tests` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_preset_craft_002/mhp_166_craft_core_tests.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP166
aep_id: AEP-MOODIFY-MHP166
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP166-20260604
