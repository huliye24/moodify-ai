# MHP-444: Visual Regression Checks

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-BUILD-022 / Build Plan-6C: Visual Validation / B14 (Execution)
**Depends on**: MHP-443
...
Complete `Visual Regression Checks` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_444_visual_regression_checks.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP444
aep_id: AEP-MOODIFY-MHP444
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP444-20260604
