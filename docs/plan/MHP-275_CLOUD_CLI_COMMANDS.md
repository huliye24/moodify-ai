# MHP-275: Cloud CLI Commands

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-BUILD-013 / Build Plan-6B: Runtime/Product Integration / B7 (Execution)
**Depends on**: MHP-274
...
Complete `Cloud CLI Commands` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/cloud_cli_commands.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP275
aep_id: AEP-MOODIFY-MHP275
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP275-20260604
