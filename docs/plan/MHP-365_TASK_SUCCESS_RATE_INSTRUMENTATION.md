# MHP-365: Task Success Rate Instrumentation

**Status**: completed
**Direction**: ECHAIN-MOODIFY-VELOCITY-006 / NEM-MOODIFY-VELOCITY-PROBE-018 / Probe Plan-6B: Velocity Instrumentation / P7 (Execution)
**Depends on**: MHP-364
...
Complete `Task Success Rate Instrumentation` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`docs/spec/task_success_rate_instrumentation.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP365
aep_id: AEP-MOODIFY-MHP365
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP365-20260604
