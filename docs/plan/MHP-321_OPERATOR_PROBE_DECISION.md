...
Complete `Operator Probe Decision` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_321_operator_probe_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP321
aep_id: AEP-MOODIFY-MHP321
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP321-20260604
