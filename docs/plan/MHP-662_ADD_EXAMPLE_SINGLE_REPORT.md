# MHP-662: Add Example Single Report

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-ACOUSTIC-CT-BUILD-034 / Build Plan-6C: Product Integration / B16 (Validation)
**Depends on**: MHP-661
...
`reports/echain-moodify-pdf-report-011/mhp_662_add_example_single_report.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP662
aep_id: AEP-MOODIFY-MHP662
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-662-20260604
