# MHP-296: Cloud Release Protocol

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-SYSTEM-014 / System Plan-6B: Product Connection / S10 (Validation)
**Depends on**: MHP-295
...
Complete `Cloud Release Protocol` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_296_cloud_release_protocol.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP296
aep_id: AEP-MOODIFY-MHP296
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP296-20260604
