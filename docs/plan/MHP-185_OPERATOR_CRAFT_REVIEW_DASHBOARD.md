...
Complete `Operator Craft Review Dashboard` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/operator_craft_review_dashboard.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP185
aep_id: AEP-MOODIFY-MHP185
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP185-20260604
