# MHP-234: Reviewer Calibration Manual

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-SYSTEM-011 / System Plan-6A: Standardization / S2 (Execution)
**Depends on**: MHP-233
...
Complete `Reviewer Calibration Manual` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/reviewer_calibration_manual.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP234
aep_id: AEP-MOODIFY-MHP234
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP234-20260604
