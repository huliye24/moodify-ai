...
Complete `Cloud Config Profiles` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_279_cloud_config_profiles.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP279
aep_id: AEP-MOODIFY-MHP279
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP279-20260604
