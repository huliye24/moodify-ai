...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-PROBE-012 / Probe Plan-6B: Technical Probe / P10 (Validation)
**Depends on**: MHP-259
...
Complete `Cost Record Probe` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_260_cost_record_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP260
aep_id: AEP-MOODIFY-MHP260
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP260-20260604
