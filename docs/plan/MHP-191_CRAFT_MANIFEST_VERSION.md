...
Complete `Craft Manifest Version` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/craft_manifest_version.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP191
aep_id: AEP-MOODIFY-MHP191
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP191-20260604
