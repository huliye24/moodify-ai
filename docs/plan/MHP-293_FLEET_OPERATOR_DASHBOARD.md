...
Complete `Fleet Operator Dashboard` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/fleet_operator_dashboard.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP293
aep_id: AEP-MOODIFY-MHP293
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP293-20260604
