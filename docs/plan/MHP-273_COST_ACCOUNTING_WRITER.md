# MHP-273: Cost Accounting Writer

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-BUILD-013 / Build Plan-6A: Core Implementation / B5 (Systemization)
**Depends on**: MHP-272
...
Complete `Cost Accounting Writer` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_273_cost_accounting_writer.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP273
aep_id: AEP-MOODIFY-MHP273
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP273-20260604
