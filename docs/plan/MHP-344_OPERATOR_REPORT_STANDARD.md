# MHP-344: Operator Report Standard

**Status**: completed
**Direction**: ECHAIN-MOODIFY-OPERATOR-OS-005 / NEM-MOODIFY-OPERATOR-SYSTEM-017 / System Plan-6A: Standardization / S4 (Validation)
**Depends on**: MHP-343
...
Complete `Operator Report Standard` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_344_operator_report_standard.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP344
aep_id: AEP-MOODIFY-MHP344
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP344-20260604
