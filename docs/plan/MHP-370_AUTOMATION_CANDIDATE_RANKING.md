# MHP-370: Automation Candidate Ranking

**Status**: completed
**Direction**: ECHAIN-MOODIFY-VELOCITY-006 / NEM-MOODIFY-VELOCITY-PROBE-018 / Probe Plan-6B: Velocity Instrumentation / P12 (Next Entry)
**Depends on**: MHP-369
...
Complete `Automation Candidate Ranking` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_370_automation_candidate_ranking.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP370
aep_id: AEP-MOODIFY-MHP370
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP370-20260604
