...
Complete `Progress Streaming Contract` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `docs/spec/runtime_progress_stream.md`.

## Expected Output

`docs/spec/runtime_progress_stream.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP132
aep_id: AEP-MOODIFY-MHP132
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP132-20260604
