# MHP-192: Craft Ownership Map

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PRESET-CRAFT-002 / NEM-MOODIFY-PRESET-SYSTEM-008 / System Plan-6C: Next Chain Entry / S14 (Execution)
**Depends on**: MHP-191
...
Complete `Craft Ownership Map` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/craft_ownership_map.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP192
aep_id: AEP-MOODIFY-MHP192
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP192-20260604
