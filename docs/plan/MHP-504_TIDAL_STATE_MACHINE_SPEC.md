# MHP-504: Tidal State Machine Spec

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-SYSTEM-026 / System Plan-6A: Standardization / S2 (Execution)
**Depends on**: MHP-503
...
Complete `Tidal State Machine Spec` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_core_008/mhp_504_tidal_state_machine_spec.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP504
aep_id: AEP-MOODIFY-MHP504
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-504-20260604
