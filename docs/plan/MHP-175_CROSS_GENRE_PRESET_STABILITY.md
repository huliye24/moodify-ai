...
Complete `Cross-Genre Preset Stability` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_preset_craft_002/mhp_175_cross_genre_preset_stability.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP175
aep_id: AEP-MOODIFY-MHP175
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP175-20260604
