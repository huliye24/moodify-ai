# MHP-368: Handoff Clarity Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-VELOCITY-006 / NEM-MOODIFY-VELOCITY-PROBE-018 / Probe Plan-6B: Velocity Instrumentation / P10 (Validation)
**Depends on**: MHP-367
...
Complete `Handoff Clarity Probe` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_368_handoff_clarity_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP368
aep_id: AEP-MOODIFY-MHP368
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP368-20260604
