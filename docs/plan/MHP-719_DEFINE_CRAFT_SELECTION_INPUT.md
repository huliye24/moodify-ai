# MHP-719: Define Craft Selection Input

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-INTELLIGENCE-SYSTEM-038 / System Plan-6A: Selector Core / S1 (Execution)
**Depends on**: MHP-718
...
`reports/echain-moodify-craft-22-012/mhp_719_define_craft_selection_input.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP719
aep_id: AEP-MOODIFY-MHP719
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-719-20260604
