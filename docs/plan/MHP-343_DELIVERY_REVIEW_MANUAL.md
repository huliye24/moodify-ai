...
Complete `Delivery Review Manual` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_343_delivery_review_manual.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP343
aep_id: AEP-MOODIFY-MHP343
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP343-20260604
