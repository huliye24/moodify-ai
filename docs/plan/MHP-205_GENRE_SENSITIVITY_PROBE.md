# MHP-205: Genre Sensitivity Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-PROBE-009 / Probe Plan-6B: Technical Probe / P9 (Validation)
**Depends on**: MHP-204
...
Complete `Genre Sensitivity Probe` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_205_genre_sensitivity_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP205
aep_id: AEP-MOODIFY-MHP205
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP205-20260604
