...
Complete `Cloud E-Chain Gate 3 Decision` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_303_cloud_e_chain_gate_3_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP303
aep_id: AEP-MOODIFY-MHP303
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP303-20260604
