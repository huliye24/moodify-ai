# MHP-267: Cloud Probe Decision

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-PROBE-012 / Probe Plan-6C: Feasibility Gate / P17 (Systemization)
**Depends on**: MHP-266
...
Complete `Cloud Probe Decision` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_267_cloud_probe_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP267
aep_id: AEP-MOODIFY-MHP267
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP267-20260604
