# MHP-587: Tidal Ops SLO Definition

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-PROBE-030 / Probe Plan-6C: Feasibility Gate / P13 (Execution)
**Depends on**: MHP-586
...
Complete `Tidal Ops SLO Definition` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_operations_010/mhp_587_tidal_ops_slo_definition.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP587
aep_id: AEP-MOODIFY-MHP587
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-587-20260604
