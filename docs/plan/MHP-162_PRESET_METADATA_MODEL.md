...
Complete `Preset Metadata Model` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/preset_metadata_model.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP162
aep_id: AEP-MOODIFY-MHP162
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP162-20260604
