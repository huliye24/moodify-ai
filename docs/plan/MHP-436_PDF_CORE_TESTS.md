# MHP-436: PDF Core Tests

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-BUILD-022 / Build Plan-6A: PDF Core / B6 (Next Entry)
**Depends on**: MHP-435
...
Complete `PDF Core Tests` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/acoustic_ct/pdf_core_tests.pdf`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP436
aep_id: AEP-MOODIFY-MHP436
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP436-20260604
