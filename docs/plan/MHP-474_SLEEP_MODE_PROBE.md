...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-PROBE-024 / Probe Plan-6B: Technical Probe / P8 (Execution)
**Depends on**: MHP-473
...
Complete `Sleep Mode Probe` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_core_008/mhp_474_sleep_mode_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP474
aep_id: AEP-MOODIFY-MHP474
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-474-20260604
