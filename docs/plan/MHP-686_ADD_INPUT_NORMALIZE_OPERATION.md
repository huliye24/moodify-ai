# MHP-686: Add Input Normalize Operation

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-TAXONOMY-PROBE-036 / Probe Plan-6A: Taxonomy Boundary / P4 (Validation)
**Depends on**: MHP-685
...
`reports/echain-moodify-craft-22-012/mhp_686_add_input_normalize_operation.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP686
aep_id: AEP-MOODIFY-MHP686
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-686-20260604
