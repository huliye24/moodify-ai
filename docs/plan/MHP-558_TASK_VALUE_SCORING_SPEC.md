# MHP-558: Task Value Scoring Spec

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-INTELLIGENCE-009 / NEM-MOODIFY-TIDAL-INTEL-SYSTEM-029 / System Plan-6A: Standardization / S2 (Execution)
**Depends on**: MHP-557
...
Complete `Task Value Scoring Spec` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_intelligence_009/mhp_558_task_value_scoring_spec.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP558
aep_id: AEP-MOODIFY-MHP558
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-558-20260604
