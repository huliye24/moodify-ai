# MHP-264: Two-Worker Smoke Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-PROBE-012 / Probe Plan-6C: Feasibility Gate / P14 (Execution)
**Depends on**: MHP-263
...
Complete `Two-Worker Smoke Probe` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/two_worker_smoke_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP264
aep_id: AEP-MOODIFY-MHP264
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP264-20260604
