# MHP-306: Internal Role Inventory

**Status**: completed
**Direction**: ECHAIN-MOODIFY-OPERATOR-OS-005 / NEM-MOODIFY-OPERATOR-PROBE-015 / Probe Plan-6A: Problem Boundary / P2 (Execution)
**Depends on**: MHP-305
...
Complete `Internal Role Inventory` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/internal_role_inventory.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP306
aep_id: AEP-MOODIFY-MHP306
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP306-20260604
