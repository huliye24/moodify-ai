# MHP-631: Add Dependency Spec

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-FOUNDATION-PROBE-033 / Probe Plan-6A: Foundation Boundary / P3 (Validation)
**Depends on**: MHP-630
...
`reports/echain-moodify-pdf-report-011/mhp_631_add_dependency_spec.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP631
aep_id: AEP-MOODIFY-MHP631
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-631-20260604
