# MHP-513: Tidal Core Product Smoke

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-SYSTEM-026 / System Plan-6B: Team Workflow / S11 (Systemization)
**Depends on**: MHP-512
...
Complete `Tidal Core Product Smoke` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`docs/spec/tidal_core_product_smoke.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP513
aep_id: AEP-MOODIFY-MHP513
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-513-20260604
