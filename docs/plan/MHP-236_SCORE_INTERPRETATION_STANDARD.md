# MHP-236: Score Interpretation Standard

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-SYSTEM-011 / System Plan-6A: Standardization / S4 (Validation)
**Depends on**: MHP-235
...
Complete `Score Interpretation Standard` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_236_score_interpretation_standard.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP236
aep_id: AEP-MOODIFY-MHP236
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP236-20260604
