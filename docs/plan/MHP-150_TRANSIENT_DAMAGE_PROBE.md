...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-PRESET-CRAFT-002 / NEM-MOODIFY-PRESET-PROBE-006 / Probe Plan-6B: Technical Probe / P8 (Execution)
**Depends on**: MHP-149
...
Complete `Transient Damage Probe` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/transient_damage_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP150
aep_id: AEP-MOODIFY-MHP150
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP150-20260604
