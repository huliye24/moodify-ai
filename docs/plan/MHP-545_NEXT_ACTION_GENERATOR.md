# MHP-545: Next Action Generator

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-INTELLIGENCE-009 / NEM-MOODIFY-TIDAL-INTEL-BUILD-028 / Build Plan-6B: Runtime Integration / B7 (Execution)
**Depends on**: MHP-544
...
Complete `Next Action Generator` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_intelligence_009/mhp_545_next_action_generator.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP545
aep_id: AEP-MOODIFY-MHP545
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-545-20260604
