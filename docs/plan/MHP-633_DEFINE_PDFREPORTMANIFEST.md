# MHP-633: Define PdfReportManifest

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-FOUNDATION-PROBE-033 / Probe Plan-6A: Foundation Boundary / P5 (Systemization)
**Depends on**: MHP-632
...
`reports/echain-moodify-pdf-report-011/mhp_633_define_pdfreportmanifest.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP633
aep_id: AEP-MOODIFY-MHP633
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-633-20260604
