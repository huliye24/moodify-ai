...
Complete `Resource Usage and Cost Summary` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `reports/runtime_build/resource_usage_summary.md`.

## Expected Output

`reports/runtime_build/resource_usage_summary.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP122
aep_id: AEP-MOODIFY-MHP122
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP122-20260604
