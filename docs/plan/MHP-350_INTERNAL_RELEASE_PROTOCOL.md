...
Complete `Internal Release Protocol` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_350_internal_release_protocol.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP350
aep_id: AEP-MOODIFY-MHP350
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP350-20260604
