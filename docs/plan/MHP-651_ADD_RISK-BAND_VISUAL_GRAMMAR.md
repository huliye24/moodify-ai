# MHP-651: Add Risk-Band Visual Grammar

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-ACOUSTIC-CT-BUILD-034 / Build Plan-6A: Acoustic CT Pages / B5 (Systemization)
**Depends on**: MHP-650
...
`reports/echain-moodify-pdf-report-011/mhp_651_add_risk-band_visual_grammar.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP651
aep_id: AEP-MOODIFY-MHP651
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-651-20260604
