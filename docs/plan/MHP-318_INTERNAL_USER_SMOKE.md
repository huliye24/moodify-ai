...
Complete `Internal User Smoke` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/internal_user_smoke.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP318
aep_id: AEP-MOODIFY-MHP318
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP318-20260604
