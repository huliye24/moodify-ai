...
Complete `Velocity Bottleneck Brief` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_363_velocity_bottleneck_brief.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP363
aep_id: AEP-MOODIFY-MHP363
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP363-20260604
