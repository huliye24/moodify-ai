...
Complete `Approval Flow Engine` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_325_approval_flow_engine.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP325
aep_id: AEP-MOODIFY-MHP325
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP325-20260604
