# MHP-711: Add Runtime Budget Policy

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-CHAIN-BUILD-037 / Build Plan-6B: Safety and Integration / B11 (Systemization)
**Depends on**: MHP-710
...
`reports/echain-moodify-craft-22-012/mhp_711_add_runtime_budget_policy.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP711
aep_id: AEP-MOODIFY-MHP711
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-711-20260604
