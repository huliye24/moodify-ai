...
Complete `Continuous Runtime Hours Instrumentation` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_366_continuous_runtime_hours_instrumentation.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP366
aep_id: AEP-MOODIFY-MHP366
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP366-20260604
