# MHP-426: Mini CT Sample Batch

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6C: CT Gate / P14 (Execution)
**Depends on**: MHP-425
...
Complete `Mini CT Sample Batch` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_426_mini_ct_sample_batch.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP426
aep_id: AEP-MOODIFY-MHP426
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP426-20260604
