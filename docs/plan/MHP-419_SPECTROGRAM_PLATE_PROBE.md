# MHP-419: Spectrogram Plate Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6B: Plot Feasibility Probe / P7 (Execution)
**Depends on**: MHP-418
...
Complete `Spectrogram Plate Probe` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/acoustic_ct/spectrogram_plate_probe.pdf`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP419
aep_id: AEP-MOODIFY-MHP419
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP419-20260604
