# MHP-450: PDF Template Standard

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-SYSTEM-023 / System Plan-6A: Visual Standardization / S2 (Execution)
**Depends on**: MHP-449
...
Complete `PDF Template Standard` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/acoustic_ct/pdf_template_standard.pdf`
...
The PDF template standard must include the canonical logo path and required placement rules for raw, processed, and comparison reports.
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP450
aep_id: AEP-MOODIFY-MHP450
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP450-20260604
