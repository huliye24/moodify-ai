...
Complete `Client Project Probe` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_313_client_project_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP313
aep_id: AEP-MOODIFY-MHP313
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP313-20260604
