# MHP-221: Listening CLI Commands

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-BUILD-010 / Build Plan-6B: Runtime/Product Integration / B7 (Execution)
**Depends on**: MHP-220
...
Complete `Listening CLI Commands` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/listening_cli_commands.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP221
aep_id: AEP-MOODIFY-MHP221
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP221-20260604
