...
Complete `Governance and Ownership Map` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `docs/RUNTIME_OWNERSHIP_MAP.md`.

## Expected Output

`docs/RUNTIME_OWNERSHIP_MAP.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP138
aep_id: AEP-MOODIFY-MHP138
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP138-20260604
