# MHP-560: Next Action Standard

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-INTELLIGENCE-009 / NEM-MOODIFY-TIDAL-INTEL-SYSTEM-029 / System Plan-6A: Standardization / S4 (Validation)
**Depends on**: MHP-559
...
Complete `Next Action Standard` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_intelligence_009/mhp_560_next_action_standard.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP560
aep_id: AEP-MOODIFY-MHP560
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-560-20260604
