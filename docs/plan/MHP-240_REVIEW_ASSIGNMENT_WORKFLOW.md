# MHP-240: Review Assignment Workflow

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-SYSTEM-011 / System Plan-6B: Product Connection / S8 (Execution)
**Depends on**: MHP-239
...
Complete `Review Assignment Workflow` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/review_assignment_workflow.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP240
aep_id: AEP-MOODIFY-MHP240
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP240-20260604
