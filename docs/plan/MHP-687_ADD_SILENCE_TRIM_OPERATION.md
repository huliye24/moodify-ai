# MHP-687: Add Silence Trim Operation

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-TAXONOMY-PROBE-036 / Probe Plan-6A: Taxonomy Boundary / P5 (Systemization)
**Depends on**: MHP-686
...
`reports/echain-moodify-craft-22-012/mhp_687_add_silence_trim_operation.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP687
aep_id: AEP-MOODIFY-MHP687
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-687-20260604
