# MHP-246: Listening Ownership Map

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-SYSTEM-011 / System Plan-6C: Next Chain Entry / S14 (Execution)
**Depends on**: MHP-245
...
Complete `Listening Ownership Map` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/listening_ownership_map.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP246
aep_id: AEP-MOODIFY-MHP246
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP246-20260604
