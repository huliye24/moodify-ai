...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-BUILD-031 / Build Plan-6A: Core Implementation / B2 (Execution)
**Depends on**: MHP-593
...
Complete `Tidal Console Dashboard` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_operations_010/mhp_594_tidal_console_dashboard.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP594
aep_id: AEP-MOODIFY-MHP594
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-594-20260604
