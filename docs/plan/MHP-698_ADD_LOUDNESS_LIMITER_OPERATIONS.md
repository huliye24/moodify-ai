# MHP-698: Add Loudness/Limiter Operations

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-TAXONOMY-PROBE-036 / Probe Plan-6C: Taxonomy Gate / P16 (Validation)
**Depends on**: MHP-697
...
`reports/echain-moodify-craft-22-012/mhp_698_add_loudness_limiter_operations.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP698
aep_id: AEP-MOODIFY-MHP698
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-698-20260604
