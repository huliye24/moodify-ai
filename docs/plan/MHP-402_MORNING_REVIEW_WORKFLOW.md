...
Complete `Morning Review Workflow` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_402_morning_review_workflow.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP402
aep_id: AEP-MOODIFY-MHP402
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP402-20260604
