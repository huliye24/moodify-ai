# MHP-120: Synthetic Failure Injection

**Status**: completed
**Direction**: ECHAIN-MOODIFY-RUNTIME-001 / NEM-MOODIFY-RUNTIME-BUILD-004 / Build Plan-6C: Stability Validation / B14 (Execution)
**Depends on**: MHP-119
...
Complete `Synthetic Failure Injection` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `reports/runtime_build/failure_injection.md`.

## Expected Output

`reports/runtime_build/failure_injection.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP120
aep_id: AEP-MOODIFY-MHP120
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP120-20260604
