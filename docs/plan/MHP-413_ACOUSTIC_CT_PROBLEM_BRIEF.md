# MHP-413: Acoustic CT Problem Brief

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6A: Visual Diagnosis Boundary / P1 (Execution)
**Depends on**: MHP-412
...
Complete `Acoustic CT Problem Brief` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_413_acoustic_ct_problem_brief.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP413
aep_id: AEP-MOODIFY-MHP413
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP413-20260604
