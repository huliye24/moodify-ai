# MHP-238: Listening Standardization Decision

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-SYSTEM-011 / System Plan-6A: Standardization / S6 (Next Entry)
**Depends on**: MHP-237
...
Complete `Listening Standardization Decision` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_238_listening_standardization_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP238
aep_id: AEP-MOODIFY-MHP238
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP238-20260604
