# MHP-721: Add Risk-Aware Operation Limits

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-INTELLIGENCE-SYSTEM-038 / System Plan-6A: Selector Core / S3 (Validation)
**Depends on**: MHP-720
...
`reports/echain-moodify-craft-22-012/mhp_721_add_risk-aware_operation_limits.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP721
aep_id: AEP-MOODIFY-MHP721
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-721-20260604
