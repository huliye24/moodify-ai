...
Complete `Preset Probe Decision` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_preset_craft_002/mhp_159_preset_probe_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP159
aep_id: AEP-MOODIFY-MHP159
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP159-20260604
