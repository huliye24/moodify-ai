# MHP-263: Fleet SLO Definition

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-PROBE-012 / Probe Plan-6C: Feasibility Gate / P13 (Execution)
**Depends on**: MHP-262
...
Complete `Fleet SLO Definition` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/fleet_slo_definition.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP263
aep_id: AEP-MOODIFY-MHP263
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP263-20260604
