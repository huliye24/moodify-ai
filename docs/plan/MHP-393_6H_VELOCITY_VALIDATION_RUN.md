...
Complete `6h Velocity Validation Run` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_393_6h_velocity_validation_run.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP393
aep_id: AEP-MOODIFY-MHP393
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP393-20260604
