...
Complete `Operator E-Chain Gate 3 Decision` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_357_operator_e_chain_gate_3_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP357
aep_id: AEP-MOODIFY-MHP357
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP357-20260604
