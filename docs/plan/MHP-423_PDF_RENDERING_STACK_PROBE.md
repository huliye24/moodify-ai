# MHP-423: PDF Rendering Stack Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6B: Plot Feasibility Probe / P11 (Systemization)
**Depends on**: MHP-422
...
Complete `PDF Rendering Stack Probe` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`docs/spec/pdf_rendering_stack_probe.md`
...
Probe whether the PDF rendering stack can embed the canonical Moodify logo asset without raster artifacts or layout shifts.
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP423
aep_id: AEP-MOODIFY-MHP423
nem_id: NEM-MOODIFY-ACOUSTIC-CT-PROBE-021
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP423-20260604
