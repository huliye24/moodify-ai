...
Complete `Cloud Manifest Version` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/cloud_manifest_version.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP299
aep_id: AEP-MOODIFY-MHP299
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP299-20260604
