...
Complete `Enterprise Cockpit Dashboard` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/enterprise_cockpit_dashboard.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP347
aep_id: AEP-MOODIFY-MHP347
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP347-20260604
