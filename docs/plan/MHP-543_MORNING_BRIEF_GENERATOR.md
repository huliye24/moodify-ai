...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-INTELLIGENCE-009 / NEM-MOODIFY-TIDAL-INTEL-BUILD-028 / Build Plan-6A: Core Implementation / B5 (Systemization)
**Depends on**: MHP-542
...
Complete `Morning Brief Generator` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`docs/spec/morning_brief_generator.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP543
aep_id: AEP-MOODIFY-MHP543
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-543-20260604
