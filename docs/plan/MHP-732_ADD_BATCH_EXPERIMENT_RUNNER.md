# MHP-732: Add Batch Experiment Runner

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-INTELLIGENCE-SYSTEM-038 / System Plan-6C: Seal and Next Entry / S14 (Execution)
**Depends on**: MHP-731
...
`reports/echain-moodify-craft-22-012/mhp_732_add_batch_experiment_runner.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP732
aep_id: AEP-MOODIFY-MHP732
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-732-20260604
