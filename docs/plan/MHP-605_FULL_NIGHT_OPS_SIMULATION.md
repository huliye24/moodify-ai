# MHP-605: Full Night Ops Simulation

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-BUILD-031 / Build Plan-6C: Stability Validation / B13 (Execution)
**Depends on**: MHP-604
...
Complete `Full Night Ops Simulation` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_operations_010/mhp_605_full_night_ops_simulation.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP605
aep_id: AEP-MOODIFY-MHP605
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-605-20260604
