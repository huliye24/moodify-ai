# MHP-317: Operator SLO Definition

**Status**: completed
**Direction**: ECHAIN-MOODIFY-OPERATOR-OS-005 / NEM-MOODIFY-OPERATOR-PROBE-015 / Probe Plan-6C: Feasibility Gate / P13 (Execution)
**Depends on**: MHP-316
...
Complete `Operator SLO Definition` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/operator_slo_definition.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP317
aep_id: AEP-MOODIFY-MHP317
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP317-20260604
