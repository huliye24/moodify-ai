...
Complete `Worktree Isolation Manager` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`docs/spec/worktree_isolation_manager.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP377
aep_id: AEP-MOODIFY-MHP377
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP377-20260604
