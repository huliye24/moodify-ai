...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-PROBE-024 / Probe Plan-6A: Boundary / P5 (Systemization)
**Depends on**: MHP-470
...
Complete `Tidal Core Bottleneck Brief` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`docs/spec/tidal_core_bottleneck_brief.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP471
aep_id: AEP-MOODIFY-MHP471
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP471-20260604
