...
Complete `Executable MHP Protocol` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_398_executable_mhp_protocol.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP398
aep_id: AEP-MOODIFY-MHP398
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP398-20260604
