# MHP-600: Report Attachment Workflow

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-BUILD-031 / Build Plan-6B: Runtime Integration / B8 (Execution)
**Depends on**: MHP-599
...
Complete `Report Attachment Workflow` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_operations_010/mhp_600_report_attachment_workflow.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP600
aep_id: AEP-MOODIFY-MHP600
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-600-20260604
