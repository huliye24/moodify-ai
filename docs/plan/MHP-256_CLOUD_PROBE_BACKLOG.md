...
Complete `Cloud Probe Backlog` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_256_cloud_probe_backlog.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP256
aep_id: AEP-MOODIFY-MHP256
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP256-20260604
