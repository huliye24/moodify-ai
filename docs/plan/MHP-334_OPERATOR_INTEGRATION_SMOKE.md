...
Complete `Operator Integration Smoke` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_334_operator_integration_smoke.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP334
aep_id: AEP-MOODIFY-MHP334
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP334-20260604
