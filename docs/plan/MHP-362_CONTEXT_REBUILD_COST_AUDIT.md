# MHP-362: Context Rebuild Cost Audit

**Status**: completed
**Direction**: ECHAIN-MOODIFY-VELOCITY-006 / NEM-MOODIFY-VELOCITY-PROBE-018 / Probe Plan-6A: Friction Boundary / P4 (Validation)
**Depends on**: MHP-361
...
Complete `Context Rebuild Cost Audit` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_362_context_rebuild_cost_audit.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP362
aep_id: AEP-MOODIFY-MHP362
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP362-20260604
