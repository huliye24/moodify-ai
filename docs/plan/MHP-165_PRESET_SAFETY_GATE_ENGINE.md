...
Complete `Preset Safety Gate Engine` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_preset_craft_002/mhp_165_preset_safety_gate_engine.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP165
aep_id: AEP-MOODIFY-MHP165
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP165-20260604
