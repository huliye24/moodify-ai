...
Complete `Queue Partition Audit` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_254_queue_partition_audit.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP254
aep_id: AEP-MOODIFY-MHP254
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP254-20260604
