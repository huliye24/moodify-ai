# MHP-111: Failure Classifier and Retry Policy

**Status**: completed
**Direction**: ECHAIN-MOODIFY-RUNTIME-001 / NEM-MOODIFY-RUNTIME-BUILD-004 / Build Plan-6A: Core Implementation / B5 (Systemization)
**Depends on**: MHP-110
...
Complete `Failure Classifier and Retry Policy` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `moodify_runtime/runtime_failures.py`.

## Expected Output

`moodify_runtime/runtime_failures.py`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP111
aep_id: AEP-MOODIFY-MHP111
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP111-20260604
