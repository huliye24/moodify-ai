# MHP-503: Tidal Core Module Spec

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-SYSTEM-026 / System Plan-6A: Standardization / S1 (Execution)
**Depends on**: MHP-502
...
Complete `Tidal Core Module Spec` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_core_008/mhp_503_tidal_core_module_spec.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP503
aep_id: AEP-MOODIFY-MHP503
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-503-20260604
