...
Complete `Run State Machine Spec` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `docs/spec/runtime_state_machine.md`.

## Expected Output

`docs/spec/runtime_state_machine.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP126
aep_id: AEP-MOODIFY-MHP126
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP126-20260604
