...
Complete `Dashboard Gap Audit` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_308_dashboard_gap_audit.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP308
aep_id: AEP-MOODIFY-MHP308
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP308-20260604
