# MHP-208: Listening Probe Report

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-PROBE-009 / Probe Plan-6B: Technical Probe / P12 (Next Entry)
**Depends on**: MHP-207
...
Complete `Listening Probe Report` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_208_listening_probe_report.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP208
aep_id: AEP-MOODIFY-MHP208
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP208-20260604
