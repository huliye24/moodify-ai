# MHP-612: Control Permission Spec

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-SYSTEM-032 / System Plan-6A: Standardization / S2 (Execution)
**Depends on**: MHP-611
...
Complete `Control Permission Spec` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_operations_010/mhp_612_control_permission_spec.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP612
aep_id: AEP-MOODIFY-MHP612
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-612-20260604
