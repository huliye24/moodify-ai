# MHP-312: Approval Flow Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-OPERATOR-OS-005 / NEM-MOODIFY-OPERATOR-PROBE-015 / Probe Plan-6B: Technical Probe / P8 (Execution)
**Depends on**: MHP-311
...
Complete `Approval Flow Probe` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/approval_flow_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP312
aep_id: AEP-MOODIFY-MHP312
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP312-20260604
