# MHP-425: CT Report Acceptance Criteria

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6C: CT Gate / P13 (Execution)
**Depends on**: MHP-424
...
Complete `CT Report Acceptance Criteria` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_425_ct_report_acceptance_criteria.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP425
aep_id: AEP-MOODIFY-MHP425
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP425-20260604
