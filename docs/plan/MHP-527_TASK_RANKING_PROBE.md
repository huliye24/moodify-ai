# MHP-527: Task Ranking Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-INTELLIGENCE-009 / NEM-MOODIFY-TIDAL-INTEL-PROBE-027 / Probe Plan-6B: Technical Probe / P7 (Execution)
**Depends on**: MHP-526
...
Complete `Task Ranking Probe` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_intelligence_009/mhp_527_task_ranking_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP527
aep_id: AEP-MOODIFY-MHP527
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-527-20260604
