# MHP-171: Craft Config Profiles

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PRESET-CRAFT-002 / NEM-MOODIFY-PRESET-BUILD-007 / Build Plan-6B: Runtime/Product Integration / B11 (Systemization)
**Depends on**: MHP-170
...
Complete `Craft Config Profiles` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_preset_craft_002/mhp_171_craft_config_profiles.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP171
aep_id: AEP-MOODIFY-MHP171
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP171-20260604
