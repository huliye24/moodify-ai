# MHP-336: Operator Failure Injection

**Status**: completed
**Direction**: ECHAIN-MOODIFY-OPERATOR-OS-005 / NEM-MOODIFY-OPERATOR-BUILD-016 / Build Plan-6C: Stability Validation / B14 (Execution)
**Depends on**: MHP-335
...
Complete `Operator Failure Injection` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/operator_failure_injection.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP336
aep_id: AEP-MOODIFY-MHP336
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP336-20260604
