# MHP-179: Craft Record Spec

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PRESET-CRAFT-002 / NEM-MOODIFY-PRESET-SYSTEM-008 / System Plan-6A: Standardization / S1 (Execution)
**Depends on**: MHP-178
...
Complete `Craft Record Spec` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/craft_record_spec.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP179
aep_id: AEP-MOODIFY-MHP179
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP179-20260604
