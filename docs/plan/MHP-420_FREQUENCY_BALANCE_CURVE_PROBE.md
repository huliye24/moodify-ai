# MHP-420: Frequency Balance Curve Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6B: Plot Feasibility Probe / P8 (Execution)
**Depends on**: MHP-419
...
Complete `Frequency Balance Curve Probe` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_420_frequency_balance_curve_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP420
aep_id: AEP-MOODIFY-MHP420
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP420-20260604
