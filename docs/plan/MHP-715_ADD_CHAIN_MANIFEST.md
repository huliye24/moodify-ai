# MHP-715: Add Chain Manifest

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-CHAIN-BUILD-037 / Build Plan-6C: CLI and Product / B15 (Validation)
**Depends on**: MHP-714
...
`reports/echain-moodify-craft-22-012/mhp_715_add_chain_manifest.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP715
aep_id: AEP-MOODIFY-MHP715
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-715-20260604
