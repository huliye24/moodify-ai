...
Complete `Operator Workflow Map` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/operator_workflow_map.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP305
aep_id: AEP-MOODIFY-MHP305
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP305-20260604
