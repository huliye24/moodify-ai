# MHP-684: Define Craft Operation Schema

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-TAXONOMY-PROBE-036 / Probe Plan-6A: Taxonomy Boundary / P2 (Execution)
**Depends on**: MHP-683
...
`reports/echain-moodify-craft-22-012/mhp_684_define_craft_operation_schema.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP684
aep_id: AEP-MOODIFY-MHP684
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-684-20260604
