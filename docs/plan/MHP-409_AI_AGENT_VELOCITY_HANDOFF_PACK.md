...
Complete `AI Agent Velocity Handoff Pack` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_409_ai_agent_velocity_handoff_pack.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP409
aep_id: AEP-MOODIFY-MHP409
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP409-20260604
