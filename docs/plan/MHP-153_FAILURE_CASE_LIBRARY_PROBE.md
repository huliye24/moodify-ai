...
Complete `Failure Case Library Probe` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_preset_craft_002/mhp_153_failure_case_library_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP153
aep_id: AEP-MOODIFY-MHP153
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP153-20260604
