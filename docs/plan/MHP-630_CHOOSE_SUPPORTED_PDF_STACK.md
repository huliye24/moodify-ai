# MHP-630: Choose Supported PDF Stack

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-FOUNDATION-PROBE-033 / Probe Plan-6A: Foundation Boundary / P2 (Execution)
**Depends on**: MHP-629
...
`reports/echain-moodify-pdf-report-011/mhp_630_choose_supported_pdf_stack.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP630
aep_id: AEP-MOODIFY-MHP630
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-630-20260604
