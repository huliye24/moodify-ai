# MHP-326: Client Project Order Views

**Status**: completed
**Direction**: ECHAIN-MOODIFY-OPERATOR-OS-005 / NEM-MOODIFY-OPERATOR-BUILD-016 / Build Plan-6A: Core Implementation / B4 (Validation)
**Depends on**: MHP-325
...
Complete `Client Project Order Views` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_326_client_project_order_views.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP326
aep_id: AEP-MOODIFY-MHP326
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP326-20260604
