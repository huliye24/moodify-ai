# MHP-429: Acoustic CT Probe Decision

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6C: CT Gate / P17 (Systemization)
**Depends on**: MHP-428
...
Complete `Acoustic CT Probe Decision` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`docs/spec/acoustic_ct_probe_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP429
aep_id: AEP-MOODIFY-MHP429
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP429-20260604
