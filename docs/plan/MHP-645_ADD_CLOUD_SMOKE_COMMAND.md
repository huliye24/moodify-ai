# MHP-645: Add Cloud Smoke Command

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-FOUNDATION-PROBE-033 / Probe Plan-6C: Foundation Gate / P17 (Systemization)
**Depends on**: MHP-644
...
`reports/echain-moodify-pdf-report-011/mhp_645_add_cloud_smoke_command.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP645
aep_id: AEP-MOODIFY-MHP645
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-645-20260604
