# MHP-528: Evidence Weight Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-INTELLIGENCE-009 / NEM-MOODIFY-TIDAL-INTEL-PROBE-027 / Probe Plan-6B: Technical Probe / P8 (Execution)
**Depends on**: MHP-527
...
Complete `Evidence Weight Probe` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_intelligence_009/mhp_528_evidence_weight_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP528
aep_id: AEP-MOODIFY-MHP528
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-528-20260604
