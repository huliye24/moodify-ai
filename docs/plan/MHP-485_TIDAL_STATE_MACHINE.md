# MHP-485: Tidal State Machine

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-BUILD-025 / Build Plan-6A: Core Implementation / B1 (Execution)
**Depends on**: MHP-484
...
Complete `Tidal State Machine` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_core_008/mhp_485_tidal_state_machine.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP485
aep_id: AEP-MOODIFY-MHP485
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-485-20260604
