# MHP-244: Listening Product Smoke

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-SYSTEM-011 / System Plan-6B: Product Connection / S12 (Next Entry)
**Depends on**: MHP-243
...
Complete `Listening Product Smoke` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_244_listening_product_smoke.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP244
aep_id: AEP-MOODIFY-MHP244
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP244-20260604
