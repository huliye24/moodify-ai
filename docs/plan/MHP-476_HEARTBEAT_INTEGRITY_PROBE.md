...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-PROBE-024 / Probe Plan-6B: Technical Probe / P10 (Validation)
**Depends on**: MHP-475
...
Complete `Heartbeat Integrity Probe` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_core_008/mhp_476_heartbeat_integrity_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP476
aep_id: AEP-MOODIFY-MHP476
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-476-20260604
