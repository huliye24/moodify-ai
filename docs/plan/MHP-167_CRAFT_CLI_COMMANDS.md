# MHP-167: Craft CLI Commands

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PRESET-CRAFT-002 / NEM-MOODIFY-PRESET-BUILD-007 / Build Plan-6B: Runtime/Product Integration / B7 (Execution)
**Depends on**: MHP-166
...
Complete `Craft CLI Commands` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/craft_cli_commands.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP167
aep_id: AEP-MOODIFY-MHP167
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP167-20260604
