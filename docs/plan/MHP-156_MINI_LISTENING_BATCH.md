...
Complete `Mini Listening Batch` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/mini_listening_batch.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP156
aep_id: AEP-MOODIFY-MHP156
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP156-20260604
