...
Complete `Listening Build Entry` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_214_listening_build_entry.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP214
aep_id: AEP-MOODIFY-MHP214
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP214-20260604
