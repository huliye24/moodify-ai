...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-PROBE-024 / Probe Plan-6C: Feasibility Gate / P17 (Systemization)
**Depends on**: MHP-482
...
Complete `Tidal Core Probe Decision` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`docs/spec/tidal_core_probe_decision.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP483
aep_id: AEP-MOODIFY-MHP483
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-483-20260604
