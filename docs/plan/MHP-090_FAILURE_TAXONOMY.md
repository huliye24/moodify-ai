# MHP-090: Runtime Failure Taxonomy

**Status**: completed
**Direction**: ECHAIN-MOODIFY-RUNTIME-001 / NEM-MOODIFY-RUNTIME-PROBE-003 / Probe Plan-6A: Problem Boundary / P2 (Execution)
**Depends on**: MHP-089
...
Complete `Runtime Failure Taxonomy` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `docs/reports/runtime_failure_taxonomy.md`.

## Expected Output

`docs/reports/runtime_failure_taxonomy.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP090
aep_id: AEP-MOODIFY-MHP090
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP090-20260604
