...
Complete `A/B Comparison Report Builder` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_preset_craft_002/mhp_164_a_b_comparison_report_builder.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP164
aep_id: AEP-MOODIFY-MHP164
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP164-20260604
