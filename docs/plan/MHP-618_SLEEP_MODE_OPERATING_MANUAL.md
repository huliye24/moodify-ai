# MHP-618: Sleep Mode Operating Manual

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-SYSTEM-032 / System Plan-6B: Team Workflow / S8 (Execution)
**Depends on**: MHP-617
...
Complete `Sleep Mode Operating Manual` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_operations_010/mhp_618_sleep_mode_operating_manual.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP618
aep_id: AEP-MOODIFY-MHP618
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-618-20260604
