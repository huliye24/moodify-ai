# MHP-666: Add CLI pdf-report render-comparison

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-OPS-QA-SYSTEM-035 / System Plan-6A: CLI and API / S2 (Execution)
**Depends on**: MHP-665
...
`reports/echain-moodify-pdf-report-011/mhp_666_add_cli_pdf-report_render-comparison.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP666
aep_id: AEP-MOODIFY-MHP666
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-666-20260604
