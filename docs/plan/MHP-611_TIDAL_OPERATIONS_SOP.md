# MHP-611: Tidal Operations SOP

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-SYSTEM-032 / System Plan-6A: Standardization / S1 (Execution)
**Depends on**: MHP-610
...
Complete `Tidal Operations SOP` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_operations_010/mhp_611_tidal_operations_sop.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP611
aep_id: AEP-MOODIFY-MHP611
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-611-20260604
