# MHP-445: PDF Artifact QA

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-BUILD-022 / Build Plan-6C: Visual Validation / B15 (Validation)
**Depends on**: MHP-444
...
Complete `PDF Artifact QA` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/acoustic_ct/pdf_artifact_qa.pdf`
...
QA must verify the logo is present, correctly scaled, non-distorted, and not cropped in every generated PDF artifact.
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP445
aep_id: AEP-MOODIFY-MHP445
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP445-20260604
