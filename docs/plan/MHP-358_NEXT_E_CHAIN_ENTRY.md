...
Complete `Next E-Chain Entry` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_358_next_e_chain_entry.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP358
aep_id: AEP-MOODIFY-MHP358
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP358-20260604
