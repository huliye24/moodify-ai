# MHP-693: Add Dynamics Operations

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-TAXONOMY-PROBE-036 / Probe Plan-6B: Operation Build / P11 (Systemization)
**Depends on**: MHP-692
...
`reports/echain-moodify-craft-22-012/mhp_693_add_dynamics_operations.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP693
aep_id: AEP-MOODIFY-MHP693
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-693-20260604
