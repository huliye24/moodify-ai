...
Complete `Auto Next Action Generator` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_385_auto_next_action_generator.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP385
aep_id: AEP-MOODIFY-MHP385
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP385-20260604
