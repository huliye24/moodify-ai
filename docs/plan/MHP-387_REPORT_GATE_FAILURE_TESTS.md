# MHP-387: Report Gate Failure Tests

**Status**: completed
**Direction**: ECHAIN-MOODIFY-VELOCITY-006 / NEM-MOODIFY-VELOCITY-BUILD-019 / Build Plan-6B: Report, Gate, and Failure Automation / B11 (Systemization)
**Depends on**: MHP-386
...
Complete `Report Gate Failure Tests` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_387_report_gate_failure_tests.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP387
aep_id: AEP-MOODIFY-MHP387
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP387-20260604
