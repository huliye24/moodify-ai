# MHP-223: Console Listening Review Views

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-BUILD-010 / Build Plan-6B: Runtime/Product Integration / B9 (Validation)
**Depends on**: MHP-222
...
Complete `Console Listening Review Views` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_223_console_listening_review_views.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP223
aep_id: AEP-MOODIFY-MHP223
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP223-20260604
