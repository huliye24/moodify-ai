# MHP-724: Selector Core Tests

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-INTELLIGENCE-SYSTEM-038 / System Plan-6A: Selector Core / S6 (Next Entry)
**Depends on**: MHP-723
...
`reports/echain-moodify-craft-22-012/mhp_724_selector_core_tests.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP724
aep_id: AEP-MOODIFY-MHP724
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-724-20260604
