...
Complete `Listening Config Profiles` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_225_listening_config_profiles.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP225
aep_id: AEP-MOODIFY-MHP225
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP225-20260604
