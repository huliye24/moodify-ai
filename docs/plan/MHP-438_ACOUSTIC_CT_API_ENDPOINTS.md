# MHP-438: Acoustic CT API Endpoints

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-BUILD-022 / Build Plan-6B: Runtime and Product Integration / B8 (Execution)
**Depends on**: MHP-437
...
Complete `Acoustic CT API Endpoints` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_438_acoustic_ct_api_endpoints.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP438
aep_id: AEP-MOODIFY-MHP438
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP438-20260604
