# MHP-660: Add PDF Filename Policy

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-ACOUSTIC-CT-BUILD-034 / Build Plan-6C: Product Integration / B14 (Execution)
**Depends on**: MHP-659
...
`reports/echain-moodify-pdf-report-011/mhp_660_add_pdf_filename_policy.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP660
aep_id: AEP-MOODIFY-MHP660
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-660-20260604
