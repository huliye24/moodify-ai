# MHP-669: Add Job Runner Hook

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-OPS-QA-SYSTEM-035 / System Plan-6A: CLI and API / S5 (Systemization)
**Depends on**: MHP-668
...
`reports/echain-moodify-pdf-report-011/mhp_669_add_job_runner_hook.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP669
aep_id: AEP-MOODIFY-MHP669
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-669-20260604
