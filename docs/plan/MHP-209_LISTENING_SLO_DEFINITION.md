...
Complete `Listening SLO Definition` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/listening_slo_definition.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP209
aep_id: AEP-MOODIFY-MHP209
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP209-20260604
