# MHP-531: Next Action Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-INTELLIGENCE-009 / NEM-MOODIFY-TIDAL-INTEL-PROBE-027 / Probe Plan-6B: Technical Probe / P11 (Systemization)
**Depends on**: MHP-530
...
Complete `Next Action Probe` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`docs/spec/next_action_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP531
aep_id: AEP-MOODIFY-MHP531
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-531-20260604
