# MHP-351: Operator Runbook

**Status**: completed
**Direction**: ECHAIN-MOODIFY-OPERATOR-OS-005 / NEM-MOODIFY-OPERATOR-SYSTEM-017 / System Plan-6B: Product Connection / S11 (Systemization)
**Depends on**: MHP-350
...
Complete `Operator Runbook` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_351_operator_runbook.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP351
aep_id: AEP-MOODIFY-MHP351
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP351-20260604
