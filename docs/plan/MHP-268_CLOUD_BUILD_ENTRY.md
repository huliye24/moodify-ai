...
Complete `Cloud Build Entry` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_268_cloud_build_entry.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP268
aep_id: AEP-MOODIFY-MHP268
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP268-20260604
