...
Complete `Cloud System Entry` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_286_cloud_system_entry.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP286
aep_id: AEP-MOODIFY-MHP286
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP286-20260604
