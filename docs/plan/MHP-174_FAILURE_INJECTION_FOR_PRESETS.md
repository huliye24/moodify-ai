...
Complete `Failure Injection for Presets` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/failure_injection_for_presets.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP174
aep_id: AEP-MOODIFY-MHP174
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP174-20260604
