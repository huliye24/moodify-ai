# MHP-311: Job Board Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-OPERATOR-OS-005 / NEM-MOODIFY-OPERATOR-PROBE-015 / Probe Plan-6B: Technical Probe / P7 (Execution)
**Depends on**: MHP-310
...
Complete `Job Board Probe` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/job_board_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP311
aep_id: AEP-MOODIFY-MHP311
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP311-20260604
