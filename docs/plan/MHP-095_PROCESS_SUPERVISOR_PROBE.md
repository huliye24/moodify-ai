# MHP-095: Process Supervisor Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-RUNTIME-001 / NEM-MOODIFY-RUNTIME-PROBE-003 / Probe Plan-6B: Technical Probe / P7 (Execution)
**Depends on**: MHP-094
...
Complete `Process Supervisor Probe` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `reports/runtime_probe/process_supervisor_probe.md`.

## Expected Output

`reports/runtime_probe/process_supervisor_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP095
aep_id: AEP-MOODIFY-MHP095
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP095-20260604
