...
Complete `Delivery Artifact Linkage` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_295_delivery_artifact_linkage.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP295
aep_id: AEP-MOODIFY-MHP295
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP295-20260604
