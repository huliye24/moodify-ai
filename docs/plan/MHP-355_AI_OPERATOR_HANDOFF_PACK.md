...
Complete `AI Operator Handoff Pack` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_355_ai_operator_handoff_pack.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP355
aep_id: AEP-MOODIFY-MHP355
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP355-20260604
