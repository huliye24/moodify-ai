# MHP-417: Visualization Risk Brief

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6A: Visual Diagnosis Boundary / P5 (Systemization)
**Depends on**: MHP-416
...
Complete `Visualization Risk Brief` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`docs/spec/visualization_risk_brief.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP417
aep_id: AEP-MOODIFY-MHP417
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP417-20260604
