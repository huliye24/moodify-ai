# MHP-416: Treatment Delta Plot Inventory

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6A: Visual Diagnosis Boundary / P4 (Validation)
**Depends on**: MHP-415
...
Complete `Treatment Delta Plot Inventory` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_416_treatment_delta_plot_inventory.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP416
aep_id: AEP-MOODIFY-MHP416
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP416-20260604
