...
Complete `Job Board Implementation` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/job_board_implementation.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP324
aep_id: AEP-MOODIFY-MHP324
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP324-20260604
