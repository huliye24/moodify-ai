# MHP-446: Report Size Performance Summary

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-BUILD-022 / Build Plan-6C: Visual Validation / B16 (Validation)
**Depends on**: MHP-445
...
Complete `Report Size Performance Summary` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_446_report_size_performance_summary.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP446
aep_id: AEP-MOODIFY-MHP446
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP446-20260604
