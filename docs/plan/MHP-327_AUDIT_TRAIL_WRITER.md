...
Complete `Audit Trail Writer` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_327_audit_trail_writer.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP327
aep_id: AEP-MOODIFY-MHP327
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP327-20260604
