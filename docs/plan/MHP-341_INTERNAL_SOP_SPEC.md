# MHP-341: Internal SOP Spec

**Status**: completed
**Direction**: ECHAIN-MOODIFY-OPERATOR-OS-005 / NEM-MOODIFY-OPERATOR-SYSTEM-017 / System Plan-6A: Standardization / S1 (Execution)
**Depends on**: MHP-340
...
Complete `Internal SOP Spec` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/internal_sop_spec.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP341
aep_id: AEP-MOODIFY-MHP341
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP341-20260604
