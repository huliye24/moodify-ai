# MHP-489: Tidal Safety Cutoff Engine

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-BUILD-025 / Build Plan-6A: Core Implementation / B5 (Systemization)
**Depends on**: MHP-488
...
Complete `Tidal Safety Cutoff Engine` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`docs/spec/tidal_safety_cutoff_engine.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP489
aep_id: AEP-MOODIFY-MHP489
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-489-20260604
