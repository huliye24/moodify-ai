...
Complete `Craft API Endpoints` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/craft_api_endpoints.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP168
aep_id: AEP-MOODIFY-MHP168
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP168-20260604
