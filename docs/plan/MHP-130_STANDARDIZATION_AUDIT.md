...
Complete `Runtime Standardization Audit` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `reports/runtime_system/standardization_audit.md`.

## Expected Output

`reports/runtime_system/standardization_audit.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP130
aep_id: AEP-MOODIFY-MHP130
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP130-20260604
