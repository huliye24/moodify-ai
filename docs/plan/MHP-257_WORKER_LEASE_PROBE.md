# MHP-257: Worker Lease Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-PROBE-012 / Probe Plan-6B: Technical Probe / P7 (Execution)
**Depends on**: MHP-256
...
Complete `Worker Lease Probe` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/worker_lease_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP257
aep_id: AEP-MOODIFY-MHP257
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP257-20260604
