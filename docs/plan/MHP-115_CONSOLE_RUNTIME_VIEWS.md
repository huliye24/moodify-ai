...
Complete `Console Runtime Views` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `moodify_runtime/operator_console.html`.
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP115
aep_id: AEP-MOODIFY-MHP115
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP115-20260604
