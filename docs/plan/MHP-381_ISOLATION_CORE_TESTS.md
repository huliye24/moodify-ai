...
Complete `Isolation Core Tests` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_381_isolation_core_tests.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP381
aep_id: AEP-MOODIFY-MHP381
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP381-20260604
