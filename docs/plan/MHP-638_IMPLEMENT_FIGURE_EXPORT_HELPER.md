# MHP-638: Implement Figure Export Helper

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-FOUNDATION-PROBE-033 / Probe Plan-6B: Template Foundation / P10 (Validation)
**Depends on**: MHP-637
...
`reports/echain-moodify-pdf-report-011/mhp_638_implement_figure_export_helper.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP638
aep_id: AEP-MOODIFY-MHP638
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-638-20260604
