...
Complete `Listening Resource Cost Summary` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_230_listening_resource_cost_summary.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP230
aep_id: AEP-MOODIFY-MHP230
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP230-20260604
