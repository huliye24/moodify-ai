# MHP-367: Automation Coverage Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-VELOCITY-006 / NEM-MOODIFY-VELOCITY-PROBE-018 / Probe Plan-6B: Velocity Instrumentation / P9 (Validation)
**Depends on**: MHP-366
...
Complete `Automation Coverage Probe` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_367_automation_coverage_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP367
aep_id: AEP-MOODIFY-MHP367
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP367-20260604
