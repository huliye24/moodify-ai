# MHP-690: Add Low-Mid and Mid Operations

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-TAXONOMY-PROBE-036 / Probe Plan-6B: Operation Build / P8 (Execution)
**Depends on**: MHP-689
...
`reports/echain-moodify-craft-22-012/mhp_690_add_low-mid_and_mid_operations.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP690
aep_id: AEP-MOODIFY-MHP690
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-690-20260604
