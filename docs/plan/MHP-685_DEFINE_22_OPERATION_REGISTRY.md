# MHP-685: Define 22 Operation Registry

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-TAXONOMY-PROBE-036 / Probe Plan-6A: Taxonomy Boundary / P3 (Validation)
**Depends on**: MHP-684
...
`reports/echain-moodify-craft-22-012/mhp_685_define_22_operation_registry.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP685
aep_id: AEP-MOODIFY-MHP685
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-685-20260604
