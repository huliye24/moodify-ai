...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-PROBE-012 / Probe Plan-6B: Technical Probe / P11 (Systemization)
**Depends on**: MHP-260
...
Complete `Failure Isolation Probe` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_261_failure_isolation_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP261
aep_id: AEP-MOODIFY-MHP261
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP261-20260604
