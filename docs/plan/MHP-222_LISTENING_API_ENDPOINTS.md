# MHP-222: Listening API Endpoints

**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-BUILD-010 / Build Plan-6B: Runtime/Product Integration / B8 (Execution)
**Depends on**: MHP-221
...
Complete `Listening API Endpoints` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/listening_api_endpoints.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP222
aep_id: AEP-MOODIFY-MHP222
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP222-20260604
