# MHP-287: Worker Contract Spec

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-SYSTEM-014 / System Plan-6A: Standardization / S1 (Execution)
**Depends on**: MHP-286
...
Complete `Worker Contract Spec` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/worker_contract_spec.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP287
aep_id: AEP-MOODIFY-MHP287
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP287-20260604
