...
Complete `Benchmark Dataset Standard` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_mrs_listening_003/mhp_235_benchmark_dataset_standard.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP235
aep_id: AEP-MOODIFY-MHP235
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP235-20260604
