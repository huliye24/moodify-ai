...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-BUILD-031 / Build Plan-6A: Core Implementation / B4 (Validation)
**Depends on**: MHP-595
...
Complete `Morning Brief Inbox` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_operations_010/mhp_596_morning_brief_inbox.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP596
aep_id: AEP-MOODIFY-MHP596
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-596-20260604
