# MHP-424: Acoustic CT Probe Report

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-PROBE-021 / Probe Plan-6B: Plot Feasibility Probe / P12 (Next Entry)
**Depends on**: MHP-423
...
Complete `Acoustic CT Probe Report` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_424_acoustic_ct_probe_report.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP424
aep_id: AEP-MOODIFY-MHP424
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP424-20260604
