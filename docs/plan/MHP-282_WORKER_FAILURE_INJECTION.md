...
Complete `Worker Failure Injection` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/worker_failure_injection.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP282
aep_id: AEP-MOODIFY-MHP282
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP282-20260604
