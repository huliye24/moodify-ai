# MHP-583: Alert Surface Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-PROBE-030 / Probe Plan-6B: Technical Probe / P9 (Validation)
**Depends on**: MHP-582
...
Complete `Alert Surface Probe` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_operations_010/mhp_583_alert_surface_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP583
aep_id: AEP-MOODIFY-MHP583
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-583-20260604
