...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-PROBE-024 / Probe Plan-6A: Boundary / P2 (Execution)
**Depends on**: MHP-467
...
Complete `Tidal Lifecycle Vocabulary` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_core_008/mhp_468_tidal_lifecycle_vocabulary.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP468
aep_id: AEP-MOODIFY-MHP468
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP468-20260604
