...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-PRESET-CRAFT-002 / NEM-MOODIFY-PRESET-PROBE-006 / Probe Plan-6B: Technical Probe / P9 (Validation)
**Depends on**: MHP-150
...
Complete `Stereo Width Probe` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_preset_craft_002/mhp_151_stereo_width_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP151
aep_id: AEP-MOODIFY-MHP151
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP151-20260604
