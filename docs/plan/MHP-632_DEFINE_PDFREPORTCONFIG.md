# MHP-632: Define PdfReportConfig

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PDF-REPORT-011 / NEM-MOODIFY-PDF-FOUNDATION-PROBE-033 / Probe Plan-6A: Foundation Boundary / P4 (Validation)
**Depends on**: MHP-631
...
`reports/echain-moodify-pdf-report-011/mhp_632_define_pdfreportconfig.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP632
aep_id: AEP-MOODIFY-MHP632
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-632-20260604
