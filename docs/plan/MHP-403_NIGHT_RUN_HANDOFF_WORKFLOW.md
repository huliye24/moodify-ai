...
Complete `Night Run Handoff Workflow` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_403_night_run_handoff_workflow.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP403
aep_id: AEP-MOODIFY-MHP403
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP403-20260604
