...
Complete `Worker Provisioning Workflow` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/worker_provisioning_workflow.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP294
aep_id: AEP-MOODIFY-MHP294
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP294-20260604
