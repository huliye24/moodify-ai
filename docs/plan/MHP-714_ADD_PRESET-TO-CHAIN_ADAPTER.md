# MHP-714: Add Preset-to-Chain Adapter

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-CHAIN-BUILD-037 / Build Plan-6C: CLI and Product / B14 (Execution)
**Depends on**: MHP-713
...
`reports/echain-moodify-craft-22-012/mhp_714_add_preset-to-chain_adapter.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP714
aep_id: AEP-MOODIFY-MHP714
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-714-20260604
