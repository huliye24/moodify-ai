...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-CORE-008 / NEM-MOODIFY-TIDAL-CORE-PROBE-024 / Probe Plan-6B: Technical Probe / P12 (Next Entry)
**Depends on**: MHP-477
...
Complete `Tidal Core Probe Report` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_core_008/mhp_478_tidal_core_probe_report.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP478
aep_id: AEP-MOODIFY-MHP478
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-478-20260604
