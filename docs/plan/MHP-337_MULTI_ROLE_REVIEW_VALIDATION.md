...
Complete `Multi-Role Review Validation` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_operator_os_005/mhp_337_multi_role_review_validation.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP337
aep_id: AEP-MOODIFY-MHP337
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP337-20260604
