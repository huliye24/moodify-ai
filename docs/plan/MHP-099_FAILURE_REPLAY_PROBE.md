# MHP-099: Failure Replay Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-RUNTIME-001 / NEM-MOODIFY-RUNTIME-PROBE-003 / Probe Plan-6B: Technical Probe / P11 (Systemization)
**Depends on**: MHP-098
...
Complete `Failure Replay Probe` as an evidence-producing step in the Runtime Productionization chain. The expected primary artifact is `reports/runtime_probe/failure_replay_probe.md`.

## Expected Output

`reports/runtime_probe/failure_replay_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP099
aep_id: AEP-MOODIFY-MHP099
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP099-20260604
