...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-MRS-LISTENING-003 / NEM-MOODIFY-LISTENING-BUILD-010 / Build Plan-6A: Core Implementation / B1 (Execution)
**Depends on**: MHP-214
...
Complete `Label Dataset Schema` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/label_dataset_schema.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP215
aep_id: AEP-MOODIFY-MHP215
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP215-20260604
