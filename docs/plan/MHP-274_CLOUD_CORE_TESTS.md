# MHP-274: Cloud Core Tests

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CLOUD-WORKER-004 / NEM-MOODIFY-CLOUD-BUILD-013 / Build Plan-6A: Core Implementation / B6 (Next Entry)
**Depends on**: MHP-273
...
Complete `Cloud Core Tests` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`reports/echain_moodify_cloud_worker_004/mhp_274_cloud_core_tests.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP274
aep_id: AEP-MOODIFY-MHP274
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP274-20260604
