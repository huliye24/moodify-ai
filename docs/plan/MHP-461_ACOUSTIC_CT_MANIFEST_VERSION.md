# MHP-461: Acoustic CT Manifest Version

**Status**: completed
**Direction**: ECHAIN-MOODIFY-ACOUSTIC-CT-007 / NEM-MOODIFY-ACOUSTIC-CT-SYSTEM-023 / System Plan-6C: Seal and Next Entry / S13 (Execution)
**Depends on**: MHP-460
...
Complete `Acoustic CT Manifest Version` as a state-converting AEP for Acoustic CT reporting. The work should make audio quality easier to inspect, compare, explain, and archive.

## Expected Output

`reports/echain_moodify_acoustic_ct_007/mhp_461_acoustic_ct_manifest_version.md`
...
The manifest must record the brand asset path and checksum so future reports can reproduce the same branded PDF output.
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP461
aep_id: AEP-MOODIFY-MHP461
nem_id: NEM-MOODIFY-ACOUSTIC-CT-SYSTEM-023
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP461-20260604
