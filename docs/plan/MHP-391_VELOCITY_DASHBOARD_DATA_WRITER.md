...
**Status**: completed
**Direction**: ECHAIN-MOODIFY-VELOCITY-006 / NEM-MOODIFY-VELOCITY-BUILD-019 / Build Plan-6C: Night Run Validation / B15 (Validation)
**Depends on**: MHP-390
...
Complete `Velocity Dashboard Data Writer` as a state-converting AEP for engineering velocity. The output should make future cloud work faster, less interrupt-driven, and easier for humans or agents to resume.

## Expected Output

`reports/echain_moodify_velocity_006/mhp_391_velocity_dashboard_data_writer.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP391
aep_id: AEP-MOODIFY-MHP391
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP391-20260604
