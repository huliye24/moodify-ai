# MHP-716: Add CLI craft plan/run/inspect

**Status**: completed
**Direction**: ECHAIN-MOODIFY-CRAFT-22-012 / NEM-MOODIFY-CRAFT-CHAIN-BUILD-037 / Build Plan-6C: CLI and Product / B16 (Validation)
**Depends on**: MHP-715
...
`reports/echain-moodify-craft-22-012/mhp_716_add_cli_craft_plan_run_inspect.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP716
aep_id: AEP-MOODIFY-MHP716
nem_id: NEM-MOODIFY-CRAFT-CHAIN-BUILD-037
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-716-20260604
