# MHP-143: Craft State Map

**Status**: completed
**Direction**: ECHAIN-MOODIFY-PRESET-CRAFT-002 / NEM-MOODIFY-PRESET-PROBE-006 / Probe Plan-6A: Problem Boundary / P1 (Execution)
**Depends on**: MHP-142
...
Complete `Craft State Map` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/craft_state_map.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP143
aep_id: AEP-MOODIFY-MHP143
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP143-20260604
