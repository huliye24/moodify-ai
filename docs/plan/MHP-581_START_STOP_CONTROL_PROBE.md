# MHP-581: Start Stop Control Probe

**Status**: completed
**Direction**: ECHAIN-MOODIFY-TIDAL-OPERATIONS-010 / NEM-MOODIFY-TIDAL-OPS-PROBE-030 / Probe Plan-6B: Technical Probe / P7 (Execution)
**Depends on**: MHP-580
...
Complete `Start Stop Control Probe` as a state-converting AEP for turning the tidal loop into a system-level module. The result should make the cycle more autonomous, safer, more inspectable, or easier to operate.

## Expected Output

`reports/echain_moodify_tidal_operations_010/mhp_581_start_stop_control_probe.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP581
aep_id: AEP-MOODIFY-MHP581
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP-581-20260604
