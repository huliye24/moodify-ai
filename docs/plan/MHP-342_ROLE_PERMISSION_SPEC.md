...
Complete `Role Permission Spec` as a state-converting AEP inside the E-Chain. The work should create evidence, reduce ambiguity, and leave a reusable artifact for the next step.

## Expected Output

`docs/spec/role_permission_spec.md`
...
```yaml
# ── Identity ──
seal_id: SEAL-MOODIFY-MHP342
aep_id: AEP-MOODIFY-MHP342
...
# ── PoEW Reference ──
poew_id: POEW-MOODIFY-MHP342-20260604
