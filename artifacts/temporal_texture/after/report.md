...
- Generated: `2026-08-04T05:37:58.463411+00:00`
...
| `moodify-bridge/src/moodify_bridge/services.py` | 62 |
| `moodify_runtime/pdf_ct_builder.py` | 44 |
| `moodify_runtime/runner.py` | 40 |
| `experiments/validate_mrs_open_v03.py` | 32 |
| `docs/strategy/DOC-MFY-001/assets/build_docx.py` | 30 |
| `moodify_runtime/craft_processes.py` | 28 |
| `moodify_runtime/operator_console.py` | 26 |
| `scripts/mrs_validate_five_experiments.py` | 25 |
| `tools/studio_session_prep/studio_prep.py` | 25 |
...
| `moodify-core-package/src/moodify/orchestration/workflow_engine.py` | 20 |
| `moodify-core-package/src/moodify/score_engine/midi_ingest.py` | 20 |
| `moodify_runtime/pdf_report.py` | 19 |
| `moodify-bridge/src/moodify_bridge/metrics.py` | 17 |
...
| ERROR | `TT-FUNCTION-LENGTH` | `docs/strategy/DOC-MFY-003/generate_docx.py:127` | `build_charter` | Function spans 340 lines; review responsibility boundaries. |
| ERROR | `TT-FUNCTION-LENGTH` | `docs/strategy/DOC-MFY-003/generate_docx.py:472` | `build_requirements` | Function spans 194 lines; review responsibility boundaries. |
| ERROR | `TT-FUNCTION-LENGTH` | `docs/strategy/DOC-MFY-003/generate_docx.py:671` | `build_acceptance` | Function spans 188 lines; review responsibility boundaries. |
| ERROR | `TT-COMPLEXITY` | `experiments/physics/EXP-PHYS-002/code/analyze.py:85` | `analyze_coupling` | Function complexity proxy is 21; branch pressure may hide decisions. |
| ERROR | `TT-EMPTY-EXCEPTION` | `experiments/physics/EXP-PHYS-002/code/scan.py:30` | `single_axis_scan` | Empty exception handler hides failure evidence. |
| ERROR | `TT-EMPTY-EXCEPTION` | `experiments/physics/EXP-PHYS-002/code/scan.py:53` | `coupling_scan` | Empty exception handler hides failure evidence. |
| ERROR | `TT-COMPLEXITY` | `experiments/validate_mrs_open_v03.py:316` | `run_v5_bad_samples` | Function complexity proxy is 23; branch pressure may hide decisions. |
| ERROR | `TT-COMPLEXITY` | `experiments/validate_mrs_open_v03.py:423` | `run_v6_improvements` | Function complexity proxy is 23; branch pressure may hide decisions. |
| ERROR | `TT-COMPLEXITY` | `experiments/validate_mrs_open_v03.py:526` | `run_v7_hq_damage` | Function complexity proxy is 32; branch pressure may hide decisions. |
| ERROR | `TT-FUNCTION-LENGTH` | `experiments/validate_mrs_open_v03.py:526` | `run_v7_hq_damage` | Function spans 163 lines; review responsibility boundaries. |
| ERROR | `TT-COMPLEXITY` | `experiments/validate_mrs_open_v03.py:929` | `write_markdown_report` | Function complexity proxy is 40; branch pressure may hide decisions. |
| ERROR | `TT-FUNCTION-LENGTH` | `experiments/validate_mrs_open_v03.py:929` | `write_markdown_report` | Function spans 309 lines; review responsibility boundaries. |
| ERROR | `TT-COMPLEXITY` | `experiments/validate_mrs_open_v03.py:1273` | `main` | Function complexity proxy is 28; branch pressure may hide decisions. |
| ERROR | `TT-FUNCTION-LENGTH` | `experiments/validate_mrs_open_v03.py:1273` | `main` | Function spans 228 lines; review responsibility boundaries. |
| ERROR | `TT-FUNCTION-LENGTH` | `moodify-bridge/src/moodify_bridge/services.py:168` | `promote_rule_atomic` | Function spans 136 lines; review responsibility boundaries. |
| ERROR | `TT-COMPLEXITY` | `moodify-bridge/src/moodify_bridge/services.py:364` | `evaluate_gates` | Function complexity proxy is 25; branch pressure may hide decisions. |
| ERROR | `TT-FUNCTION-LENGTH` | `moodify-bridge/src/moodify_bridge/services.py:473` | `ppe_run` | Function spans 143 lines; review responsibility boundaries. |
| ERROR | `TT-PARAMETERS` | `moodify-bridge/src/moodify_bridge/services.py:618` | `_build_manifest` | Function has 11 declared parameters; implicit context may need a named structure. |
| ERROR | `TT-COMPLEXITY` | `moodify-bridge/src/moodify_bridge/services.py:1072` | `refine_prepare` | Function complexity proxy is 26; branch pressure may hide decisions. |
| ERROR | `TT-FUNCTION-LENGTH` | `moodify-bridge/src/moodify_bridge/services.py:1072` | `refine_prepare` | Function spans 192 lines; review responsibility boundaries. |
...
| ERROR | `TT-EMPTY-EXCEPTION` | `moodify-core-package/src/moodify/adapters/audacity/runtime.py:170` | `run_macro` | Empty exception handler hides failure evidence. |
...
| ERROR | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/capability_registry/adapters/base.py:177` | `invoke` | Function complexity proxy is 23; branch pressure may hide decisions. |
...
| ERROR | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/craft_slider.py:139` | `slide` | Function complexity proxy is 26; branch pressure may hide decisions. |
| ERROR | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/craft_slider.py:139` | `slide` | Function spans 147 lines; review responsibility boundaries. |
...
| ERROR | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/features/f0.py:220` | `analyze_f0` | Function complexity proxy is 25; branch pressure may hide decisions. |
| ERROR | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/features/f0.py:220` | `analyze_f0` | Function spans 154 lines; review responsibility boundaries. |
...
| ERROR | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/score_engine/midi_ingest.py:106` | `_parse_track` | Function complexity proxy is 26; branch pressure may hide decisions. |
| ERROR | `TT-NESTING` | `moodify-core-package/src/moodify/score_engine/midi_ingest.py:106` | `_parse_track` | Maximum nesting depth is 8; failure and decision paths are compressed. |
| ERROR | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/score_engine/musescore_backend.py:129` | `export` | Function complexity proxy is 29; branch pressure may hide decisions. |
...
| ERROR | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/transcription_pipeline/midi_cleanup.py:66` | `cleanup_midi` | Function complexity proxy is 32; branch pressure may hide decisions. |
| ERROR | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/transcription_pipeline/runner.py:68` | `transcribe_stems` | Function complexity proxy is 27; branch pressure may hide decisions. |
| ERROR | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/transcription_pipeline/runner.py:68` | `transcribe_stems` | Function spans 138 lines; review responsibility boundaries. |
...
| ERROR | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/v01_pipeline.py:34` | `process_audio` | Function spans 174 lines; review responsibility boundaries. |
...
| ERROR | `TT-PARAMETERS` | `moodify_runtime/fusion_scorer.py:163` | `compute_fusion_score` | Function has 17 declared parameters; implicit context may need a named structure. |
...
| ERROR | `TT-PARAMETERS` | `moodify_runtime/operator_console.py:302` | `decide_candidate_gate` | Function has 12 declared parameters; implicit context may need a named structure. |
...
| ERROR | `TT-COMPLEXITY` | `moodify_runtime/significance_evaluator.py:118` | `compare_groups` | Function complexity proxy is 22; branch pressure may hide decisions. |
...
| ERROR | `TT-COMPLEXITY` | `tools/architecture/budget.py:82` | `collect_budget` | Function complexity proxy is 30; branch pressure may hide decisions. |
| ERROR | `TT-NESTING` | `tools/score_asset_pipeline.py:49` | `parse_notes` | Maximum nesting depth is 7; failure and decision paths are compressed. |
| ERROR | `TT-COMPLEXITY` | `tools/studio_session_prep/candidate_plan.py:120` | `generate_candidate_plans` | Function complexity proxy is 27; branch pressure may hide decisions. |
| ERROR | `TT-FUNCTION-LENGTH` | `tools/studio_session_prep/candidate_plan.py:120` | `generate_candidate_plans` | Function spans 163 lines; review responsibility boundaries. |
| ERROR | `TT-FUNCTION-LENGTH` | `tools/studio_session_prep/reporting.py:104` | `build_markdown_report` | Function spans 187 lines; review responsibility boundaries. |
| ERROR | `TT-FUNCTION-LENGTH` | `tools/studio_session_prep/studio_prep.py:116` | `_cmd_session_init` | Function spans 144 lines; review responsibility boundaries. |
| ERROR | `TT-EMPTY-EXCEPTION` | `tools/studio_session_prep/studio_prep.py:234` | `_cmd_session_init` | Empty exception handler hides failure evidence. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `apps/tools/audacity_cli.py:116` | `main` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-FUNCTION-LENGTH` | `docs/strategy/DOC-MFY-001/assets/generate_diagrams.py:69` | `fig2_experiment_flywheel` | Function spans 65 lines; review responsibility boundaries. |
| WARNING | `TT-FUNCTION-LENGTH` | `docs/strategy/DOC-MFY-001/assets/generate_diagrams.py:137` | `fig3_expansion_path` | Function spans 63 lines; review responsibility boundaries. |
...
| WARNING | `TT-FUNCTION-LENGTH` | `docs/strategy/DOC-MFY-003/assets/generate_diagrams.py:34` | `draw_scope` | Function spans 71 lines; review responsibility boundaries. |
| WARNING | `TT-FUNCTION-LENGTH` | `docs/strategy/DOC-MFY-003/assets/generate_diagrams.py:110` | `draw_priority` | Function spans 85 lines; review responsibility boundaries. |
| WARNING | `TT-FUNCTION-LENGTH` | `docs/strategy/DOC-MFY-003/assets/generate_diagrams.py:200` | `draw_cadence` | Function spans 69 lines; review responsibility boundaries. |
| WARNING | `TT-FUNCTION-LENGTH` | `docs/strategy/DOC-MFY-003/executions/ACU-005/generate_limiter_ab.py:25` | `plot_envelope_comparison` | Function spans 72 lines; review responsibility boundaries. |
...
| WARNING | `TT-COMPLEXITY` | `experiments/engineering/EXP-ENG-001/code/analyze.py:64` | `compute_listener_reliability` | Function complexity proxy is 19; branch pressure may hide decisions. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `experiments/physics/EXP-PHYS-002/code/analyze.py:56` | `check_unreachable_targets` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `experiments/physics/EXP-PHYS-002/code/scan.py:30` | `single_axis_scan` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `experiments/physics/EXP-PHYS-002/code/scan.py:53` | `coupling_scan` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-NESTING` | `experiments/validate_mrs_open_v03.py:131` | `load_v02_data` | Maximum nesting depth is 6; failure and decision paths are compressed. |
| WARNING | `TT-COMPLEXITY` | `experiments/validate_mrs_open_v03.py:164` | `find_baseline_audio_paths` | Function complexity proxy is 13; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `experiments/validate_mrs_open_v03.py:231` | `run_v4_correlation` | Function spans 79 lines; review responsibility boundaries. |
| WARNING | `TT-FUNCTION-LENGTH` | `experiments/validate_mrs_open_v03.py:316` | `run_v5_bad_samples` | Function spans 101 lines; review responsibility boundaries. |
| WARNING | `TT-FUNCTION-LENGTH` | `experiments/validate_mrs_open_v03.py:423` | `run_v6_improvements` | Function spans 97 lines; review responsibility boundaries. |
...
| WARNING | `TT-COMPLEXITY` | `experiments/validate_mrs_open_v03.py:695` | `run_v8_loudness_cheat` | Function complexity proxy is 15; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `experiments/validate_mrs_open_v03.py:695` | `run_v8_loudness_cheat` | Function spans 72 lines; review responsibility boundaries. |
...
| WARNING | `TT-COMPLEXITY` | `experiments/validate_mrs_open_v03.py:773` | `run_v9_stability` | Function complexity proxy is 15; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `experiments/validate_mrs_open_v03.py:773` | `run_v9_stability` | Function spans 108 lines; review responsibility boundaries. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `experiments/validate_mrs_open_v03.py:860` | `run_v9_stability` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-PARAMETERS` | `moodify-bridge/src/moodify_bridge/cli.py:119` | `hypothesis_create` | Function has 7 declared parameters; implicit context may need a named structure. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/cli.py:203` | `ppe_run_command` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/cli.py:249` | `refine_prepare_command` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/cli.py:262` | `refine_prepare_command` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/services.py:145` | `_read_promotion_marker` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-COMPLEXITY` | `moodify-bridge/src/moodify_bridge/services.py:168` | `promote_rule_atomic` | Function complexity proxy is 19; branch pressure may hide decisions. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/services.py:264` | `promote_rule_atomic` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/services.py:279` | `promote_rule_atomic` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/services.py:286` | `promote_rule_atomic` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/services.py:294` | `promote_rule_atomic` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-COMPLEXITY` | `moodify-bridge/src/moodify_bridge/services.py:335` | `build_report` | Function complexity proxy is 14; branch pressure may hide decisions. |
...
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-bridge/src/moodify_bridge/services.py:364` | `evaluate_gates` | Function spans 74 lines; review responsibility boundaries. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/services.py:463` | `_collect_environment` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-COMPLEXITY` | `moodify-bridge/src/moodify_bridge/services.py:473` | `ppe_run` | Function complexity proxy is 13; branch pressure may hide decisions. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/services.py:500` | `ppe_run` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/services.py:534` | `ppe_run` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/services.py:562` | `ppe_run` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/services.py:578` | `ppe_run` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-bridge/src/moodify_bridge/services.py:598` | `ppe_run` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-COMPLEXITY` | `moodify-bridge/src/moodify_bridge/services.py:723` | `detect_conflicts` | Function complexity proxy is 13; branch pressure may hide decisions. |
| WARNING | `TT-NESTING` | `moodify-bridge/src/moodify_bridge/services.py:818` | `_build_refine_html` | Maximum nesting depth is 6; failure and decision paths are compressed. |
| WARNING | `TT-COMPLEXITY` | `moodify-bridge/src/moodify_bridge/services.py:913` | `_analyze_lyrics_structure` | Function complexity proxy is 14; branch pressure may hide decisions. |
| WARNING | `TT-COMPLEXITY` | `moodify-bridge/src/moodify_bridge/services.py:970` | `_process_lyrics` | Function complexity proxy is 14; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-bridge/src/moodify_bridge/services.py:970` | `_process_lyrics` | Function spans 100 lines; review responsibility boundaries. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/adapters/audacity/client.py:41` | `detect_audacity_process` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/adapters/audacity/client.py:73` | `_pipe_available` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/adapters/audacity/runtime.py:100` | `run_macro` | Function spans 73 lines; review responsibility boundaries. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/adapters/audacity/runtime.py:163` | `run_macro` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/adapters/audacity/runtime.py:170` | `run_macro` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/app/engines.py:47` | `execute` | Function complexity proxy is 16; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/app/engines.py:47` | `execute` | Function spans 85 lines; review responsibility boundaries. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/app/engines.py:108` | `execute` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/app/evidence.py:24` | `aggregate_evidence` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/app/orchestrator.py:36` | `analyze_audio` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/app/production_control.py:102` | `validate_spec_fields` | Function complexity proxy is 16; branch pressure may hide decisions. |
| WARNING | `TT-PARAMETERS` | `moodify-core-package/src/moodify/app/production_control.py:181` | `specify` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/app/production_control.py:607` | `verify` | Function complexity proxy is 16; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/app/production_control.py:607` | `verify` | Function spans 72 lines; review responsibility boundaries. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/app/production_control.py:635` | `verify` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/app/production_control.py:682` | `package` | Function spans 78 lines; review responsibility boundaries. |
| WARNING | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/app/production_control.py:767` | `_validate_package` | Function complexity proxy is 17; branch pressure may hide decisions. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/app/production_control.py:842` | `_package_version` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/capability_registry/adapters/base.py:177` | `invoke` | Function spans 82 lines; review responsibility boundaries. |
| WARNING | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/capability_registry/adapters/basic_pitch_adapter.py:56` | `invoke` | Function complexity proxy is 14; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/capability_registry/adapters/basic_pitch_adapter.py:56` | `invoke` | Function spans 63 lines; review responsibility boundaries. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/capability_registry/adapters/basic_pitch_adapter.py:97` | `invoke` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/capability_registry/adapters/cli.py:32` | `cmd_capability_invoke` | Function complexity proxy is 14; branch pressure may hide decisions. |
| WARNING | `TT-PARAMETERS` | `moodify-core-package/src/moodify/capability_registry/bootstrap.py:29` | `_capability` | Function has 8 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/capability_registry/bootstrap.py:76` | `build_registry` | Function spans 87 lines; review responsibility boundaries. |
...
| WARNING | `TT-PARAMETERS` | `moodify-core-package/src/moodify/capability_registry/knowledge/policy.py:141` | `propose_rule_change` | Function has 9 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify-core-package/src/moodify/capability_registry/knowledge/records.py:173` | `new_measurement` | Function has 9 declared parameters; implicit context may need a named structure. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/cli_daw/adapters/matchering.py:34` | `execute` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/cli_daw/adapters/rubberband.py:30` | `probe` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/cli_daw/adapters/rubberband.py:47` | `execute` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/cli_daw/adapters/sox.py:31` | `probe` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-NESTING` | `moodify-core-package/src/moodify/cli_daw/adapters/sox.py:36` | `execute` | Maximum nesting depth is 5; failure and decision paths are compressed. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/cli_daw/adapters/sox.py:54` | `execute` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/cli_daw/engine_ffmpeg.py:73` | `ffmpeg_render` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/cli_daw/engine_native.py:102` | `native_render` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-NESTING` | `moodify-core-package/src/moodify/cli_daw/engine_native.py:113` | `_apply_processing` | Maximum nesting depth is 6; failure and decision paths are compressed. |
| WARNING | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/cli_daw/project.py:78` | `validate` | Function complexity proxy is 14; branch pressure may hide decisions. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/craft_slider.py:51` | `_extract_mrs` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/craft_slider.py:60` | `_extract_damage` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/features/f0.py:153` | `_estimate_vibrato` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/features/f0.py:262` | `analyze_f0` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/features/perceptual.py:241` | `_extract_mel` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:396` | `_process_candidates` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:432` | `_narrate_diagnosis` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:457` | `_save_history` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:485` | `_update_calibration` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:494` | `_build_result` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:559` | `_run_diagnosis` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:583` | `_run_load_audio` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:612` | `_run_spectral_enhancement_multi` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:676` | `_resolve_spatial_width` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-PARAMETERS` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:709` | `_export_wav` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:720` | `_run_mastering` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:747` | `_run_mastering` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:758` | `_run_mastering` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-PARAMETERS` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:766` | `_run_strength_search` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/orchestration/workflow_engine.py:792` | `_run_strength_search` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/perception/masking.py:321` | `analyze` | Function spans 70 lines; review responsibility boundaries. |
...
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/processing/limiter.py:177` | `apply_limiter_tp` | Function spans 114 lines; review responsibility boundaries. |
| WARNING | `TT-PARAMETERS` | `moodify-core-package/src/moodify/processing/limiter.py:177` | `apply_limiter_tp` | Function has 7 declared parameters; implicit context may need a named structure. |
...
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/processing/rbj_eq.py:190` | `apply_rbj_eq` | Function spans 61 lines; review responsibility boundaries. |
...
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/processing/tight_focus.py:258` | `apply_tight_focus` | Function spans 61 lines; review responsibility boundaries. |
...
| WARNING | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/score_engine/cli.py:35` | `cmd_score_export` | Function complexity proxy is 13; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/score_engine/midi_ingest.py:106` | `_parse_track` | Function spans 89 lines; review responsibility boundaries. |
| WARNING | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/score_engine/midi_ingest.py:197` | `parse_midi` | Function complexity proxy is 14; branch pressure may hide decisions. |
...
| WARNING | `TT-NESTING` | `moodify-core-package/src/moodify/score_engine/musescore_backend.py:116` | `validate` | Maximum nesting depth is 5; failure and decision paths are compressed. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/score_engine/musescore_backend.py:129` | `export` | Function spans 69 lines; review responsibility boundaries. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/transcription.py:83` | `transcribe` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/transcription_pipeline/midi_cleanup.py:66` | `cleanup_midi` | Function spans 106 lines; review responsibility boundaries. |
| WARNING | `TT-NESTING` | `moodify-core-package/src/moodify/transcription_pipeline/midi_cleanup.py:66` | `cleanup_midi` | Maximum nesting depth is 5; failure and decision paths are compressed. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/v01_delivery.py:36` | `_sha256_hex` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/v01_delivery.py:44` | `_file_size` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/v01_delivery.py:115` | `_git_hash` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/v01_delivery.py:128` | `_git_branch` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/v01_pipeline.py:198` | `process_audio` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-COMPLEXITY` | `moodify-core-package/src/moodify/v01_pipeline.py:224` | `scan_audio` | Function complexity proxy is 18; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/v01_pipeline.py:224` | `scan_audio` | Function spans 79 lines; review responsibility boundaries. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/v01_pipeline.py:291` | `scan_audio` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/v01_pipeline.py:300` | `scan_audio` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/v01_pipeline.py:341` | `_quality_gate` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/v01_pipeline.py:486` | `_save_pdf_report` | Function spans 101 lines; review responsibility boundaries. |
| WARNING | `TT-PARAMETERS` | `moodify-core-package/src/moodify/v01_pipeline.py:486` | `_save_pdf_report` | Function has 8 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/src/moodify/v01_pipeline.py:496` | `_save_pdf_report` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify-core-package/src/moodify/v01_pipeline.py:589` | `_generate_delivery_artifacts` | Function spans 70 lines; review responsibility boundaries. |
| WARNING | `TT-PARAMETERS` | `moodify-core-package/src/moodify/v01_pipeline.py:589` | `_generate_delivery_artifacts` | Function has 8 declared parameters; implicit context may need a named structure. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify-core-package/tests/score_engine/test_musescore_backend.py:40` | `real_backend` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify_runtime/backfill_loader.py:59` | `backfill` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/benchmark_builder.py:96` | `add_entry` | Function has 9 declared parameters; implicit context may need a named structure. |
...
| WARNING | `TT-COMPLEXITY` | `moodify_runtime/cli.py:487` | `_handle_tidal_commands` | Function complexity proxy is 16; branch pressure may hide decisions. |
| WARNING | `TT-COMPLEXITY` | `moodify_runtime/cli.py:536` | `_handle_craft_commands` | Function complexity proxy is 13; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/cli.py:536` | `_handle_craft_commands` | Function spans 64 lines; review responsibility boundaries. |
| WARNING | `TT-COMPLEXITY` | `moodify_runtime/cli.py:602` | `_handle_runtime_commands` | Function complexity proxy is 14; branch pressure may hide decisions. |
| WARNING | `TT-LINE-LENGTH` | `moodify_runtime/cli.py:622` | `` | Line length is 131 characters; expression may be compressed. |
| WARNING | `TT-COMPLEXITY` | `moodify_runtime/cli.py:648` | `_handle_operator_commands` | Function complexity proxy is 13; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/cli.py:648` | `_handle_operator_commands` | Function spans 86 lines; review responsibility boundaries. |
...
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/comparison_report.py:57` | `generate_comparison_markdown` | Function spans 67 lines; review responsibility boundaries. |
...
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_evidence.py:100` | `create_step_evidence` | Function has 7 declared parameters; implicit context may need a named structure. |
...
| WARNING | `TT-NESTING` | `moodify_runtime/craft_processes.py:60` | `validate_params` | Maximum nesting depth is 6; failure and decision paths are compressed. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:686` | `_op_input_normalize` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:701` | `_op_silence_trim` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:728` | `_op_dc_offset_repair` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:738` | `_op_sub_bass_discipline` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:752` | `_op_bass_body_shaping` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:766` | `_op_low_mid_de_mud` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:780` | `_op_mid_presence_lift` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:794` | `_op_harshness_guard` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:806` | `_op_air_recovery` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:819` | `_op_sibilance_guard` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:831` | `_op_transient_soften` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:844` | `_op_transient_restore` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:856` | `_op_micro_dynamics_lift` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:873` | `_op_macro_dynamics_guard` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-LINE-LENGTH` | `moodify_runtime/craft_processes.py:883` | `` | Line length is 128 characters; expression may be compressed. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:894` | `_op_stereo_width_control` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:912` | `_op_center_focus` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:930` | `_op_noise_floor_polish` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-LINE-LENGTH` | `moodify_runtime/craft_processes.py:934` | `` | Line length is 123 characters; expression may be compressed. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:944` | `_op_room_reverb_cleanup` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:952` | `_op_warmth_injection` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:962` | `_op_clarity_polish` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:971` | `_op_loudness_landing` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/craft_processes.py:990` | `_op_final_safety_limiter` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify_runtime/craft_processes.py:1063` | `execute_operation` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify_runtime/craft_processes.py:1077` | `execute_operation` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-COMPLEXITY` | `moodify_runtime/data_asset.py:224` | `collect_evidence_package` | Function complexity proxy is 16; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/data_asset.py:224` | `collect_evidence_package` | Function spans 64 lines; review responsibility boundaries. |
| WARNING | `TT-NESTING` | `moodify_runtime/data_asset.py:396` | `ingest_sources` | Maximum nesting depth is 5; failure and decision paths are compressed. |
...
| WARNING | `TT-PARAMETERS` | `moodify_runtime/fusion_scorer.py:93` | `compute_overprocessing_penalty` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/fusion_scorer.py:163` | `compute_fusion_score` | Function spans 66 lines; review responsibility boundaries. |
...
| WARNING | `TT-COMPLEXITY` | `moodify_runtime/hardening_gates.py:18` | `check_rights_cleared` | Function complexity proxy is 16; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/hardening_gates.py:18` | `check_rights_cleared` | Function spans 75 lines; review responsibility boundaries. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify_runtime/learning_store.py:84` | `_derive_night_label` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/learning_surface.py:23` | `generate_learning_report` | Function spans 94 lines; review responsibility boundaries. |
...
| WARNING | `TT-PARAMETERS` | `moodify_runtime/mainline_registry.py:42` | `register_pack` | Function has 8 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/mainline_registry.py:66` | `register_gate_report` | Function has 8 declared parameters; implicit context may need a named structure. |
...
| WARNING | `TT-COMPLEXITY` | `moodify_runtime/mrs_surface.py:118` | `compute_mrs_surface` | Function complexity proxy is 18; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/mrs_surface.py:118` | `compute_mrs_surface` | Function spans 86 lines; review responsibility boundaries. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/mrs_surface.py:118` | `compute_mrs_surface` | Function has 9 declared parameters; implicit context may need a named structure. |
...
| WARNING | `TT-COMPLEXITY` | `moodify_runtime/operator_console.py:302` | `decide_candidate_gate` | Function complexity proxy is 19; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/operator_console.py:302` | `decide_candidate_gate` | Function spans 71 lines; review responsibility boundaries. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/operator_console.py:375` | `build_operator_detail_from_run` | Function spans 102 lines; review responsibility boundaries. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/operator_console.py:375` | `build_operator_detail_from_run` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/operator_console.py:479` | `attach_run_report_to_job` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-COMPLEXITY` | `moodify_runtime/operator_console.py:541` | `create_delivery_record` | Function complexity proxy is 16; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/operator_console.py:541` | `create_delivery_record` | Function spans 103 lines; review responsibility boundaries. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/operator_console.py:541` | `create_delivery_record` | Function has 8 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/operator_console.py:674` | `plan_operator_runtime` | Function spans 73 lines; review responsibility boundaries. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify_runtime/operator_console.py:939` | `run_operator_job` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify_runtime/operator_console.py:989` | `show_operator_runtime_plan` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/operator_console.py:1035` | `_write_summary_md` | Function has 7 declared parameters; implicit context may need a named structure. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `moodify_runtime/operator_console.py:1286` | `check_storage_health` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-PARAMETERS` | `moodify_runtime/runner.py:68` | `_build_task_context` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-COMPLEXITY` | `moodify_runtime/runner.py:89` | `_execute_task_with_retries` | Function complexity proxy is 13; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/runner.py:89` | `_execute_task_with_retries` | Function spans 78 lines; review responsibility boundaries. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify_runtime/runner.py:115` | `_execute_task_with_retries` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/runner.py:169` | `_build_manifest_row` | Function has 9 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/runner.py:227` | `_handle_rights_blocked` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-COMPLEXITY` | `moodify_runtime/runner.py:266` | `_process_one_task` | Function complexity proxy is 13; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/runner.py:266` | `_process_one_task` | Function spans 108 lines; review responsibility boundaries. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify_runtime/runner.py:299` | `_process_one_task` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/runner.py:378` | `run_daily` | Function spans 92 lines; review responsibility boundaries. |
| WARNING | `TT-PARAMETERS` | `moodify_runtime/runner.py:378` | `run_daily` | Function has 7 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-BROAD-EXCEPTION` | `moodify_runtime/runner.py:462` | `run_daily` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-FUNCTION-LENGTH` | `moodify_runtime/significance_evaluator.py:118` | `compare_groups` | Function spans 81 lines; review responsibility boundaries. |
...
| WARNING | `TT-COMPLEXITY` | `scripts/data_asset_backfill.py:25` | `main` | Function complexity proxy is 14; branch pressure may hide decisions. |
| WARNING | `TT-NESTING` | `scripts/data_asset_backfill.py:25` | `main` | Maximum nesting depth is 6; failure and decision paths are compressed. |
| WARNING | `TT-BROAD-EXCEPTION` | `scripts/data_asset_backfill.py:47` | `main` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-COMPLEXITY` | `scripts/deepseek_worker_client.py:56` | `validate_output` | Function complexity proxy is 16; branch pressure may hide decisions. |
| WARNING | `TT-PARAMETERS` | `scripts/deepseek_worker_client.py:113` | `process_tasks` | Function has 9 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-BROAD-EXCEPTION` | `scripts/deepseek_worker_client.py:147` | `process_tasks` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-FUNCTION-LENGTH` | `scripts/golden_runtime_exercise.py:43` | `main` | Function spans 63 lines; review responsibility boundaries. |
...
| WARNING | `TT-FUNCTION-LENGTH` | `scripts/moodify_deep_ear.py:31` | `analyse` | Function spans 88 lines; review responsibility boundaries. |
...
| WARNING | `TT-BROAD-EXCEPTION` | `scripts/verify_exported_master.py:55` | `_lufs` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-NESTING` | `tools/architecture/budget.py:41` | `_public_symbols` | Maximum nesting depth is 5; failure and decision paths are compressed. |
| WARNING | `TT-FUNCTION-LENGTH` | `tools/architecture/budget.py:82` | `collect_budget` | Function spans 100 lines; review responsibility boundaries. |
| WARNING | `TT-NESTING` | `tools/architecture/budget.py:82` | `collect_budget` | Maximum nesting depth is 6; failure and decision paths are compressed. |
...
| WARNING | `TT-COMPLEXITY` | `tools/architecture/enforcer.py:79` | `check_enclosure` | Function complexity proxy is 18; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `tools/architecture/enforcer.py:79` | `check_enclosure` | Function spans 69 lines; review responsibility boundaries. |
| WARNING | `TT-COMPLEXITY` | `tools/generate_midi_anchored_lrc.py:77` | `select_starts` | Function complexity proxy is 16; branch pressure may hide decisions. |
| WARNING | `TT-COMPLEXITY` | `tools/project_governance/gate.py:43` | `validate_ledger` | Function complexity proxy is 18; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `tools/project_governance/gate.py:43` | `validate_ledger` | Function spans 62 lines; review responsibility boundaries. |
| WARNING | `TT-FUNCTION-LENGTH` | `tools/project_governance/import_tasks.py:55` | `build_import_events` | Function spans 64 lines; review responsibility boundaries. |
| WARNING | `TT-COMPLEXITY` | `tools/project_governance/inventory.py:37` | `_bucket_for` | Function complexity proxy is 19; branch pressure may hide decisions. |
...
| WARNING | `TT-COMPLEXITY` | `tools/project_governance/inventory.py:76` | `build_inventory` | Function complexity proxy is 15; branch pressure may hide decisions. |
| WARNING | `TT-PARAMETERS` | `tools/project_governance/ledger.py:99` | `new_event` | Function has 9 declared parameters; implicit context may need a named structure. |
| WARNING | `TT-COMPLEXITY` | `tools/project_governance/ledger.py:124` | `derive_state` | Function complexity proxy is 15; branch pressure may hide decisions. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/project_governance/observability.py:42` | `collect` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-FUNCTION-LENGTH` | `tools/run_audacity_stage.py:39` | `main` | Function spans 72 lines; review responsibility boundaries. |
| WARNING | `TT-COMPLEXITY` | `tools/score_asset_pipeline.py:49` | `parse_notes` | Function complexity proxy is 14; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `tools/studio_session_prep/candidate_adapter.py:58` | `execute_candidate` | Function spans 79 lines; review responsibility boundaries. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/candidate_adapter.py:123` | `execute_candidate` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
...
| WARNING | `TT-COMPLEXITY` | `tools/studio_session_prep/reporting.py:28` | `build_comparison_table` | Function complexity proxy is 15; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `tools/studio_session_prep/reporting.py:28` | `build_comparison_table` | Function spans 74 lines; review responsibility boundaries. |
| WARNING | `TT-COMPLEXITY` | `tools/studio_session_prep/reporting.py:104` | `build_markdown_report` | Function complexity proxy is 18; branch pressure may hide decisions. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/studio_prep.py:79` | `_probe_audio` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-COMPLEXITY` | `tools/studio_session_prep/studio_prep.py:116` | `_cmd_session_init` | Function complexity proxy is 19; branch pressure may hide decisions. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/studio_prep.py:141` | `_cmd_session_init` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/studio_prep.py:162` | `_cmd_session_init` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/studio_prep.py:178` | `_cmd_session_init` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/studio_prep.py:187` | `_cmd_session_init` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/studio_prep.py:195` | `_cmd_session_init` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-FUNCTION-LENGTH` | `tools/studio_session_prep/studio_prep.py:262` | `_build_checklist` | Function spans 69 lines; review responsibility boundaries. |
...
| WARNING | `TT-COMPLEXITY` | `tools/studio_session_prep/studio_prep.py:334` | `_cmd_asset_verify` | Function complexity proxy is 14; branch pressure may hide decisions. |
| WARNING | `TT-FUNCTION-LENGTH` | `tools/studio_session_prep/studio_prep.py:334` | `_cmd_asset_verify` | Function spans 80 lines; review responsibility boundaries. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/studio_prep.py:349` | `_cmd_asset_verify` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/studio_prep.py:379` | `_cmd_asset_verify` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-FUNCTION-LENGTH` | `tools/studio_session_prep/studio_prep.py:420` | `_cmd_wse_analyze` | Function spans 74 lines; review responsibility boundaries. |
| WARNING | `TT-FUNCTION-LENGTH` | `tools/studio_session_prep/studio_prep.py:535` | `_cmd_candidate_compare` | Function spans 70 lines; review responsibility boundaries. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/studio_prep.py:571` | `_cmd_candidate_compare` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-COMPLEXITY` | `tools/studio_session_prep/studio_prep.py:664` | `_cmd_report_build` | Function complexity proxy is 13; branch pressure may hide decisions. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/studio_prep.py:685` | `_cmd_report_build` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/wse_profile.py:157` | `compute_wse_profile` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/studio_session_prep/wse_profile.py:209` | `compute_window_evolution` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-BROAD-EXCEPTION` | `tools/xhs_compare_video/generate_xhs_compare_video.py:260` | `paste_logo` | Broad exception handler requires contextual logging, rethrowing, or a documented boundary. |
| WARNING | `TT-FUNCTION-LENGTH` | `tools/xhs_compare_video/generate_xhs_compare_video.py:272` | `make_scene_image` | Function spans 73 lines; review responsibility boundaries. |
