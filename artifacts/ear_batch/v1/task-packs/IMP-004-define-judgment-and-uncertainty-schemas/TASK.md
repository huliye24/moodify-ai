# IMP-004 — Define Judgment and Uncertainty schemas

Promoted from `WI-004` after `TP-305` unattended-safety selection.

## Objective

Judgment references but never overwrites measurements; UNCERTAIN and INSUFFICIENT_EVIDENCE are valid outputs; severity and confidence are separate.
...
- `schemas/ear_v1/judgment_record.schema.json`
- `schemas/ear_v1/uncertainty.schema.json`
- `tests/ear_v1_contracts/test_judgment_schema.py`
