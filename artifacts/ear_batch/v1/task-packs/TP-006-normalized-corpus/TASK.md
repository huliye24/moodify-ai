# TP-006 — Create normalized read-only corpus index

Status is authoritative only in `TASK_LEDGER.json`.

## Purpose

Create a normalized manifest pointing to authoritative immutable source files. Preserve hashes and provenance; do not copy heavy PDFs unless required.
...
- `corpus/normalized_manifest.json`
- `corpus/README.md`
...
- Verification evidence is written to `evidence/TP-006.json`.
